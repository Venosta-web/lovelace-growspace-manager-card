...
export class IrrigationDialog extends LitElement {
  ...
  private _renderCropSteeringPhaseBar(color: string) {
    ...
    const toPercent = (min: number) => ((min % 1440) / 1440) * 100;

    const phases: Array<{ label: string; start: number; end: number; phaseColor: string }> = [
