...
export class DataService {
  ...
  async askGrowAdvice(growspaceId: string, userQuery: string): Promise<any> {
  ...
  async analyzeAllGrowspaces(): Promise<any> {
  ...
  async getStrainRecommendation(userQuery: string): Promise<any> {
