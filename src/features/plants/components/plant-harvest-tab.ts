...
export class PlantHarvestTab extends LitElement {
  ...
  willUpdate(changedProps: Map<string, unknown>): void {
    if (changedProps.has('plant') && this.plant) {
      ...
      const rawScores =
        (this.plant.attributes?.phenotype_score as Record<string, number | null>) || {};
      this._scoresEdit = {
  ...
  render(): TemplateResult {
    ...
    const advanceLabel =
      stage === 'dry' || stage === 'drying' ? '🌿 Skip & begin cure' : '📦 Skip & finish';
      ...
      <div style="padding: 24px; display: flex; flex-direction: column; gap: 24px;">
              ...
              <input
                ...
                @input=${(e: InputEvent) => {
                  ...
                  this._harvestMetricsEdit = {
                    ...this._harvestMetricsEdit,
                    wet_weight: v === '' ? null : parseFloat(v),
                  };
                }}
                ?disabled=${isSaving}
            ...
            <div style="display:flex; flex-direction:column; gap:4px;">
              ...
              <input
                ...
                @input=${(e: InputEvent) => {
                  ...
                  this._harvestMetricsEdit = {
                    ...this._harvestMetricsEdit,
                    dry_weight: v === '' ? null : parseFloat(v),
                  };
                }}
                ?disabled=${isSaving}
                style="background:var(--card-background-color, rgba(255,255,255,0.06)); border:1px solid var(--divider-color, rgba(255,255,255,0.15)); border-radius:8px; color:var(--primary-text-color); font-size:0.9rem; padding:6px 10px; width:100%; box-sizing:border-box;"
            ...
            <div style="display:flex; flex-direction:column; gap:4px;">
              ...
              <input
                ...
                @input=${(e: InputEvent) => {
                  ...
                  this._harvestMetricsEdit = {
                    ...this._harvestMetricsEdit,
                    trim_weight: v === '' ? null : parseFloat(v),
                  };
                }}
                ?disabled=${isSaving}
                style="background:var(--card-background-color, rgba(255,255,255,0.06)); border:1px solid var(--divider-color, rgba(255,255,255,0.15)); border-radius:8px; color:var(--primary-text-color); font-size:0.9rem; padding:6px 10px; width:100%; box-sizing:border-box;"
            ...
            <div style="display:flex; flex-direction:column; gap:4px;">
              ...
              <input
                ...
                @input=${(e: InputEvent) => {
                  ...
                  this._harvestMetricsEdit = {
                    ...this._harvestMetricsEdit,
                    thc_percentage: v === '' ? null : parseFloat(v),
                  };
                }}
                ?disabled=${isSaving}
                style="background:var(--card-background-color, rgba(255,255,255,0.06)); border:1px solid var(--divider-color, rgba(255,255,255,0.15)); border-radius:8px; color:var(--primary-text-color); font-size:0.9rem; padding:6px 10px; width:100%; box-sizing:border-box;"
            ...
            <div style="display:flex; flex-direction:column; gap:4px;">
              ...
              <input
                ...
                @input=${(e: InputEvent) => {
                  ...
                  this._harvestMetricsEdit = {
                    ...this._harvestMetricsEdit,
                    cbd_percentage: v === '' ? null : parseFloat(v),
                  };
                }}
                ?disabled=${isSaving}
                style="background:var(--card-background-color, rgba(255,255,255,0.06)); border:1px solid var(--divider-color, rgba(255,255,255,0.15)); border-radius:8px; color:var(--primary-text-color); font-size:0.9rem; padding:6px 10px; width:100%; box-sizing:border-box;"
            ...
            <div style="display:flex; flex-direction:column; gap:4px; grid-column: 1 / -1;">
              ...
              <textarea
                ...
                @input=${(e: InputEvent) => {
                  this._harvestMetricsEdit = {
                    ...this._harvestMetricsEdit,
                    terpene_profile: (e.target as HTMLTextAreaElement).value,
                  };
                }}
                ?disabled=${isSaving}
        ...
        >
          ...
          <button
            ...
            ?disabled=${isSaving}
          >
            ${isSaving ? 'Saving…' : '🌾 Save scores & metrics'}
          </button>
        </div>
      </div>
    `;
  ...
  private async _saveHarvestMetrics(): Promise<void> {
    ...
    try {
      ...
      const hasMetrics = Object.keys(this._harvestMetricsEdit).length > 0;
      ...
      if (hasMetrics) {
        await withToast(
          ...
          {
            success: 'Harvest metrics saved',
            errorPrefix: 'Failed to save harvest metrics',
            rethrow: true,
          }
        );
      }
