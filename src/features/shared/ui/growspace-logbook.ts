  ...
  render() {
    ...
    return html`
      ...
      <div
        ...
        style=${this._containerHeight > 0 ? `height: ${this._containerHeight}px` : ''}
      >
                        ...
                        <div class="event-reasons">
                          ${isNote
                            ? html`
                                ...
                                ${(event as GrowspaceEvent & { tags?: string[] }).tags &&
                                (event as GrowspaceEvent & { tags?: string[] }).tags!.length > 0
                                  ? html`
                                      <div
                                ...
                                (event as GrowspaceEvent & { images?: string[] }).images!.length > 0
                                  ? html`
                                      ...
                                      >
                                        ${(event as GrowspaceEvent & { images?: string[] }).images!
                                          .length}
                                        Image${(event as GrowspaceEvent & { images?: string[] })
                                          .images!.length > 1
                                          ? 's'
                                          : ''}
                                        attached
