...
export const METRIC_CONFIG: Record<string, MetricConfigItem> = {
  ...
  // The pump chips graph the same entities as the Irrigation and Drain schedule
  // chips, so they share those metrics' colours.
  [MetricKey.IRRIGATION_PUMP]: {
    color: token['--metric-irrigation'],
...
> = {
  ...
  [MetricKey.IRRIGATION_PUMP]: { primary: 'irrigationPumpEntity', source: 'irrigation' },
  [MetricKey.DRAIN_PUMP]: { primary: 'drainPumpEntity', source: 'irrigation' },
