...
export async function logDryingWeight(ctx: ActionContext, plantId: string, weightGrams: number, date?: string): Promise<void> {
...
export async function logMoistureReading(ctx: ActionContext, plantId: string, moisturePercent: number, date?: string): Promise<void> {
...
export async function setVisualTag(ctx: ActionContext, plantId: string, visualTag: string | null): Promise<void> {
