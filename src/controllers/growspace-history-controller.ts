...
export class GrowspaceHistoryController implements ReactiveController {
    ...
    public get historyData(): HistorySensorState[] | null { return this.historyCache['main'] || null; }
    public set historyData(value: HistorySensorState[] | null) { this.historyCache['main'] = value || []; }

    /** @deprecated Use historyCache['optimal'] instead */
    public get optimalHistory(): HistorySensorState[] | null { return this.historyCache['optimal'] || null; }
    public set optimalHistory(value: HistorySensorState[] | null) { this.historyCache['optimal'] = value || []; }

    // Backward compatibility getters for existing code that reads these properties
    public get temperatureHistory() { return this.historyCache['temperature'] || null; }
    public get humidityHistory() { return this.historyCache['humidity'] || null; }
    public get vpdHistory() { return this.historyCache['vpd'] || null; }
    public get co2History() { return this.historyCache['co2'] || null; }
    public get lightHistory() { return this.historyCache['light'] || null; }
    public get soilMoistureHistory() { return this.historyCache['soil_moisture'] || null; }
    public get exhaustHistory() { return this.historyCache['exhaust'] || null; }
    public get humidifierHistory() { return this.historyCache['humidifier'] || null; }
    public get dehumidifierHistory() { return this.historyCache['dehumidifier'] || null; }
    public get circulationFanHistory() { return this.historyCache['circulation_fan'] || null; }
    public get irrigationHistory() { return this.historyCache['irrigation'] || null; }
    public get drainHistory() { return this.historyCache['drain'] || null; }
