...
export class FanRenderer extends BaseRenderer {
  ...
  private createFanModel(): THREE.Group {
    ...
    const bladeMaterial = this.getSharedMaterial(
      'fanBladeMat',
    ...
    // Cage/Rim
    const rimGeo = this.getSharedGeometry(
      'fanRimGeo',
      () => new THREE.TorusGeometry(6, 0.5, 8, 24)
    );
