...
// Icons
import {
    mdiCog, mdiBrain, mdiDotsVertical, mdiPencil, mdiLink,
    mdiClipboardTextClock, mdiWater, mdiWaterPlus, mdiBottleTonicPlus,
    mdiBug, mdiDumbbell, mdiPlus, mdiDna
} from '@mdi/js';
...
export class GrowspaceHeaderActions extends LitElement {
    ...
    private _triggerAction(action: string) {
        ...
        if (menu && typeof menu.hidePopover === 'function') {
            try { menu.hidePopover(); } catch { /* ignore */ }
        }
        ...
        switch (action) {
            ...
            case 'edit': this.store.ui.setEditMode(!this._isEditModeController.value); break;
            case 'compact': {
            ...
            case 'strains': this.store.openStrainLibraryDialog(); break;
            case 'irrigation':
            ...
            case 'ai':
                ...
                break;
            case 'logbook': this.store.openLogbookDialog(); break;
            case 'water': {
            ...
            case 'nutrients': this.store.openNutrientsDialog(); break;
        }
    }
            ...
            <div class="gs-device-chips-container">
                <scroll-container .scrollAmount=${150} containerClass="device-chips-scroll">
                    <div class="chips-wrapper">
                        ${this.deviceChips.map(chip => html`
                            <growspace-chip
                                .icon=${chip.icon}
                                .label=${chip.label}
                                .value=${chip.value}
        ...
        return html`
          <div id="header-menu" popover="auto" class="menu-dropdown">
            ...
            <div class="menu-item" @click=${() => this._triggerAction('edit')}>
                 ...
                 <div class=${classMap({ 'menu-toggle-switch': true, active: this._isEditModeController?.value || false })}></div>
            </div>
