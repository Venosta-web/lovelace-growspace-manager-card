...
export class GrowspaceHeader extends LitElement {
  ...
  private _computeMetrics() {
    if (!this.device || !this.hass) return { mainChips: [], deviceChips: [], dominant: undefined, growspaceOptions: this.growspaceOptions, envAttrs: {} };
