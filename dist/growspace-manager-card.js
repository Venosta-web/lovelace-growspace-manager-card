      ...
      >
        <div class="glass-dialog-container" style="--stage-color: ${n}">
          ...
          <div class="overview-grid">
             ...
             <div class="detail-card">
               <h3>Timeline</h3>
               ${"mother"===a.stage?Ka.renderMD3DateInput("Mother Start",a.mother_start??"",t=>l("mother_start",t)):Z}
               ${"clone"===a.stage?Ka.renderMD3DateInput("Clone Start",a.clone_start??"",t=>l("clone_start",t)):Z}
               ${"veg"===a.stage||"flower"===a.stage?Ka.renderMD3DateInput("Vegetative Start",a.veg_start??"",t=>l("veg_start",t)):Z}
               ${"flower"===a.stage?Ka.renderMD3DateInput("Flower Start",a.flower_start??"",t=>l("flower_start",t)):Z}
               ${"dry"===a.stage||"cure"===a.stage?Ka.renderMD3DateInput("Dry Start",a.dry_start??"",t=>l("dry_start",t)):Z}
               ${"cure"===a.stage?Ka.renderMD3DateInput("Cure Start",a.cure_start??"",t=>l("cure_start",t)):Z}
             </div>
         ...
         <div class="editor-layout">
            ...
            <div class="editor-col">
               <div class="photo-upload-area"
                    @click=${t=>t.currentTarget.querySelector("input")?.click()}
                  ...
                  ${r.image?R`
                     <img src="${r.image}" style="width:100%; height:100%; object-fit:cover; border-radius:10px;" />
                     <div style="position:absolute; bottom:8px; right:8px; background:rgba(0,0,0,0.6); padding:4px; border-radius:50%;">
                        <svg style="width:20px;height:20px;fill:white;" viewBox="0 0 24 24"><path d="${"M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z"}"></path></svg>
                     </div>
                  `:R`
