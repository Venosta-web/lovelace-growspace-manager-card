        ...
        <div class="glass-dialog-container" style="--stage-color: var(--plant-border-color-default)">
          ...
          <div class="overview-grid">
             ...
             <div class="detail-card">
               ...
               ${is.renderMD3SelectInput("Strain *",e.strain||"",i,r.onStrainChange)}
               ${is.renderMD3TextInput("Phenotype",e.phenotype||"",r.onPhenotypeChange)}
               <div style="display:flex; gap:16px;">
                 ${is.renderMD3NumberInput("Row",e.row+1,e=>r.onRowChange(e))}
                 ${is.renderMD3NumberInput("Col",e.col+1,e=>r.onColChange(e))}
               </div>
             </div>
