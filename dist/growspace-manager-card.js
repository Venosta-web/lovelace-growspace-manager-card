...
`;class en{static normalizeStage(e){const t=e.toLowerCase();return"veg"===t?"vegetative":"mom"===t?"mother":t}static getPlantStageColor(e){const t=this.normalizeStage(e);return this.stageColors[t]??"#757575"}static getPlantStageIcon(e){const t=this.normalizeStage(e);return this.stageIcons[t]??Me}static getPlantStage(e){const t=e?.attributes??{},r=new Date;return t.cure_start?"cure":t.dry_start?"dry":t.mom_start?"mother":t.clone_start?"clone":t.flower_start&&new Date(t.flower_start)<=r?"flower":t.veg_start&&new Date(t.veg_start)<=r?"vegetative":"seedling"}static createGridLayout(e,t,r){const i=Array.from({length:t},()=>Array.from({length:r},()=>null));return e.forEach(e=>{const a=(e.attributes?.row??1)-1,n=(e.attributes?.col??1)-1;a>=0&&a<t&&n>=0&&n<r&&(i[a][n]=e)}),{rows:t,cols:r,grid:i}}static calculateEffectiveRows(e){const{name:t,plants:r,plants_per_row:i,rows:a}=e;if("dry"===t||"cure"===t||"mother"===t||"clone"===t){if(0===r.length)return 1;const e=Math.max(...r.map(e=>e.attributes?.row||1)),t=r.filter(t=>(t.attributes?.row||1)===e).length;return t>=i?e+1:e}return a}static parseDateTimeLocal(e){if(e)try{const t=16===e.length?e+":00":e,r=new Date(t);if(isNaN(r.getTime()))return;const i=r.getFullYear(),a=String(r.getMonth()+1).padStart(2,"0"),n=String(r.getDate()).padStart(2,"0"),s=String(r.getHours()).padStart(2,"0"),o=String(r.getMinutes()).padStart(2,"0");return`${i}-${a}-${n}T${s}:${o}:${String(r.getSeconds()).padStart(2,"0")}`}catch{return}}static formatDateForBackend(e){if(e)try{const t=e.split("T");if(t.length>0&&t[0].match(/^\d{4}-\d{2}-\d{2}$/))return t[0];const r=new Date(e);if(isNaN(r.getTime()))return;const i=r.getFullYear(),a=String(r.getMonth()+1).padStart(2,"0");return`${i}-${a}-${String(r.getDate()).padStart(2,"0")}`}catch{return}}static getCurrentDateTime(){const e=new Date,t=e=>e.toString().padStart(2,"0");return`${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}T${t(e.getHours())}:${t(e.getMinutes())}:00`}static toDateTimeLocal(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const r=e=>e.toString().padStart(2,"0"),i=t.getFullYear(),a=r(t.getMonth()+1),n=r(t.getDate()),s=r(t.getHours());return`${i}-${a}-${n}T${s}:${r(t.getMinutes())}`}catch{return""}}static getDominantStage(e){if(!e||0===e.length)return null;const t=["cure","dry","flower","vegetative","clone","mother","seedling"];let r=null,i=0;const a={};for(const t of e){const e=this.normalizeStage(t.state||this.getPlantStage(t));a[e]||(a[e]=[]),a[e].push(t)}for(const e of t)if(a[e]&&a[e].length>0){r=e;const t=`${"vegetative"===e?"veg":e}_days`,n=a[e].map(e=>{const r=e.attributes[t];return"number"==typeof r?r:0});i=Math.max(...n);break}return r?{stage:r,days:i}:null}static compressImage(e,t=800,r=800,i=.7){return new Promise((a,n)=>{const s=new FileReader;s.readAsDataURL(e),s.onload=e=>{const s=new Image;s.src=e.target?.result,s.onload=()=>{let e=s.width,o=s.height;e>o?e>t&&(o=Math.round(o*t/e),e=t):o>r&&(e=Math.round(e*r/o),o=r);const l=document.createElement("canvas");l.width=e,l.height=o;const c=l.getContext("2d");if(!c)return void n(new Error("Failed to get canvas context"));c.drawImage(s,0,0,e,o);const d=l.toDataURL("image/jpeg",i);a(d)},s.onerror=e=>n(e)},s.onerror=e=>n(e)})}}en.stageColors={mother:"#E91E63",clone:"#FF5722",seedling:"#4CAF50",vegetative:"#8BC34A",flower:"#FF9800",dry:"#795548",cure:"#9C27B0"},en.stageIcons={mother:Me,clone:Me,seedling:Me,vegetative:Me,flower:$e,dry:Se,cure:me};class tn{constructor(e){this.hass=e}getGrowspaceDevices(){if(!this.hass)return[];const e=Object.values(this.hass.states),t=e.filter(e=>e.entity_id.startsWith("sensor.")&&void 0!==e.attributes?.growspace_id&&void 0!==e.attributes?.rows&&void 0!==e.attributes?.plants_per_row&&void 0===e.attributes?.row&&void 0===e.attributes?.col),r=new Map;return t.forEach(e=>{const t=e.attributes.growspace_id;r.set(t,[])}),e.forEach(e=>{if(void 0!==e.attributes?.row&&void 0!==e.attributes?.col){const t=this.getGrowspaceId(e);r.has(t)||r.set(t,[]),r.get(t).push(e)}}),Array.from(r.entries()).map(([e,r])=>{const i=t.find(t=>t.attributes?.growspace_id===e),a=i?.attributes?.friendly_name||`Growspace ${e}`,n=i?.attributes?.type??(a.toLowerCase().includes("dry")?"dry":a.toLowerCase().includes("cure")?"cure":"normal");return s={device_id:e,overview_entity_id:i?.entity_id,name:a,plants:r,rows:i?.attributes?.rows??3,plants_per_row:i?.attributes?.plants_per_row??3,type:n},{...s,type:s.type??"normal"};var s})}getGrowspaceId(e){return e.attributes?.growspace_id||"unknown"}getStrainLibrary(){const e=Object.values(this.hass.states).find(e=>void 0!==e.attributes?.strains&&null!==e.attributes?.strains),t=e?.attributes?.strains;if(!t)return[];if(Array.isArray(t))return t.map(e=>({strain:e,phenotype:"",key:`${e}|default`}));if("object"==typeof t){const e=[];for(const[r,i]of Object.entries(t)){const t=i,a=t.analytics,n=t.meta||{};if(t.phenotypes&&"object"==typeof t.phenotypes){const i=Object.entries(t.phenotypes);if(i.length>0)for(const[t,s]of i){const i=s;let o;i.analytics?o=i.analytics:"number"==typeof i.avg_veg_days&&(o={avg_veg_days:i.avg_veg_days,avg_flower_days:i.avg_flower_days,total_harvests:i.total_harvests}),e.push({strain:r,phenotype:t,key:`${r}|${t}`,analytics:o,strain_analytics:a,image_crop_meta:i.image_crop_meta,breeder:i.breeder||n.breeder,type:i.type||n.type,lineage:i.lineage||n.lineage,sex:i.sex||n.sex,description:i.description||n.description,flowering_days_min:i.flower_days_min||n.flowering_days_min,flowering_days_max:i.flower_days_max||n.flowering_days_max,image:i.image_path||i.image||n.image,sativa_percentage:i.sativa_percentage||n.sativa_percentage,indica_percentage:i.indica_percentage||n.indica_percentage})}else e.push({strain:r,phenotype:"",key:`${r}|default`,strain_analytics:a,image_crop_meta:t.image_crop_meta,breeder:n.breeder,type:n.type,lineage:n.lineage,sex:n.sex,description:n.description,flowering_days_min:n.flowering_days_min,flowering_days_max:n.flowering_days_max,image:n.image,sativa_percentage:n.sativa_percentage,indica_percentage:n.indica_percentage})}else e.push({strain:r,phenotype:"",key:`${r}|default`,strain_analytics:a,image_crop_meta:t.image_crop_meta,breeder:n.breeder,type:n.type,lineage:n.lineage,sex:n.sex,description:n.description,flowering_days_min:n.flowering_days_min,flowering_days_max:n.flowering_days_max,image:n.image,sativa_percentage:n.sativa_percentage,indica_percentage:n.indica_percentage})}return e.sort((e,t)=>{const r=e.strain.localeCompare(t.strain);return 0!==r?r:(e.phenotype||"").localeCompare(t.phenotype||"")})}return[]}async getHistory(e,t,r){if(!this.hass)return[];let i=`history/period/${t.toISOString()}?filter_entity_id=${e}`;r&&(i+=`&end_time=${r.toISOString()}`);try{const e=await this.hass.callApi("GET",i);return e&&e.length>0?e[0]:[]}catch(e){return console.error("Error fetching history:",e),[]}}async addPlant(e){console.log("[DataService:addPlant] Sending payload:",e);try{"mother"!==e.growspace_id&&"mother_overview"!==e.growspace_id||(e.mother_start=(new Date).toISOString().split("T")[0]),"clone"!==e.growspace_id&&"clone_overview"!==e.growspace_id||(e.clone_start=(new Date).toISOString().split("T")[0]);const t=await this.hass.callService("growspace_manager","add_plant",e);return console.log("[DataService:addPlant] Response:",t),t}catch(e){throw console.error("[DataService:addPlant] Error:",e),e}}async updatePlant(e){console.log("[DataService:updatePlant] Sending payload:",e);try{const t=await this.hass.callService("growspace_manager","update_plant",e);return console.log("[DataService:updatePlant] Response:",t),t}catch(e){throw console.error("[DataService:updatePlant] Error:",e),e}}async removePlant(e){console.log("[DataService:removePlant] Removing plant_id:",e);try{const t=await this.hass.callService("growspace_manager","remove_plant",{plant_id:e});return console.log("[DataService:removePlant] Response:",t),t}catch(e){throw console.error("[DataService:removePlant] Error:",e),e}}async harvestPlant(e,t="dry"){console.log("[DataService:harvestPlant] Harvesting plant:",e,"→ target:",t);try{const r=(t||"").toLowerCase(),i={plant_id:e};r.includes("dry")?i.target_growspace_id="dry_overview":r.includes("cure")?i.target_growspace_id="cure_overview":r.includes("mother")?i.target_growspace_id="mother_overview":r.includes("clone")?i.target_growspace_id="clone_overview":r&&(i.target_growspace_name=t);const a=await this.hass.callService("growspace_manager","harvest_plant",i);return console.log("[DataService:harvestPlant] Response:",a),a}catch(e){throw console.error("[DataService:harvestPlant] Error:",e),e}}async takeClone(e,t="clone"){console.log("[DataService:takeClone] Cloning plant:",e,"→ target:",t);try{const r=(t||"").toLowerCase(),i={plant_id:e};r.includes("dry")?i.target_growspace_id="dry_overview":r.includes("cure")?i.target_growspace_id="cure_overview":r.includes("mother")?i.target_growspace_id="mother_overview":r.includes("clone")?i.target_growspace_id="clone_overview":r&&(i.target_growspace_name=t);const a=await this.hass.callService("growspace_manager","takeClone",i);return console.log("[DataService:takeClone] Response:",a),a}catch(e){throw console.error("[DataService:takeClone] Error:",e),e}}async swapPlants(e,t){console.log(`[DataService:swapPlants] Swapping plants: ${e} and ${t}`);try{const r=await this.hass.callService("growspace_manager","switch_plants",{plant1_id:e,plant2_id:t});return console.log("[DataService:swapPlants] Response:",r),r}catch(e){throw console.error("[DataService:swapPlants] Error:",e),e}}async addStrain(e){console.log("[DataService:addStrain] Adding strain:",e);try{const t={...e};Object.keys(t).forEach(e=>{void 0===t[e]&&delete t[e]}),e.image&&(e.image.startsWith("data:")?(t.image_base64=e.image,delete t.image):(t.image_path=e.image,delete t.image));const r=await this.hass.callService("growspace_manager","add_strain",t);return console.log("[DataService:addStrain] Response:",r),r}catch(e){throw console.error("[DataService:addStrain] Error:",e),e}}async removeStrain(e,t){console.log("[DataService:removeStrain] Removing strain:",e,t);try{const r=await this.hass.callService("growspace_manager","remove_strain",{strain:e,phenotype:t});return console.log("[DataService:removeStrain] Response:",r),r}catch(e){throw console.error("[DataService:removeStrain] Error:",e),e}}async importStrainLibrary(e,t){console.log("[DataService:importStrainLibrary] Importing strain library ZIP via HTTP. Replace:",t);const r=new FormData;r.append("file",e),r.append("replace",t.toString());try{const e=await fetch("/api/growspace_manager/import_strains",{method:"POST",body:r,headers:{Authorization:`Bearer ${this.hass.auth.data.access_token}`}});if(!e.ok){const t=await e.text();throw new Error(t||e.statusText)}const t=await e.json();if(console.log("[DataService:importStrainLibrary] Response:",t),t.success)return t;throw new Error(t.error||"Unknown import error")}catch(e){throw console.error("[DataService:importStrainLibrary] Error:",e),e}}async clearStrainLibrary(){console.log("[DataService:clearStrainLibrary] Clearing library");try{const e=await this.hass.callService("growspace_manager","clear_strain_library");return console.log("[DataService:clearStrainLibrary] Response:",e),e}catch(e){throw console.error("[DataService:clearStrainLibrary] Error:",e),e}}async addGrowspace(e){console.log("[DataService:addGrowspace] Adding growspace:",e);try{const t=await this.hass.callService("growspace_manager","add_growspace",e);return console.log("[DataService:addGrowspace] Response:",t),t}catch(e){throw console.error("[DataService:addGrowspace] Error:",e),e}}async configureGrowspaceSensors(e){console.log("[DataService:configureGrowspaceSensors] Configuring sensors:",e);try{const t=await this.hass.callService("growspace_manager","configure_growspace",e);return console.log("[DataService:configureGrowspaceSensors] Response:",t),t}catch(e){throw console.error("[DataService:configureGrowspaceSensors] Error:",e),e}}async configureGlobalSettings(e){console.log("[DataService:configureGlobalSettings] Configuring global settings:",e);try{const t=await this.hass.callService("growspace_manager","configure_global",e);return console.log("[DataService:configureGlobalSettings] Response:",t),t}catch(e){throw console.error("[DataService:configureGlobalSettings] Error:",e),e}}async askGrowAdvice(e,t){console.log("[DataService:askGrowAdvice] Asking advice for:",e,t);try{return await this.hass.connection.sendMessagePromise({type:"call_service",domain:"growspace_manager",service:"ask_grow_advice",service_data:{growspace_id:e,user_query:t},return_response:!0})}catch(e){throw console.error("[DataService:askGrowAdvice] Error:",e),e}}async analyzeAllGrowspaces(){console.log("[DataService:analyzeAllGrowspaces] Analyzing all growspaces");try{return await this.hass.connection.sendMessagePromise({type:"call_service",domain:"growspace_manager",service:"analyze_all_growspaces",service_data:{},return_response:!0})}catch(e){throw console.error("[DataService:analyzeAllGrowspaces] Error:",e),e}}async getStrainRecommendation(e){console.log("[DataService:getStrainRecommendation] Getting strain recommendation for:",e);try{return await this.hass.connection.sendMessagePromise({type:"call_service",domain:"growspace_manager",service:"strain_recommendation",service_data:{user_query:e},return_response:!0})}catch(e){throw console.error("[DataService:getStrainRecommendation] Error:",e),e}}}var rn,an;!function(e){e.language="language",e.system="system",e.comma_decimal="comma_decimal",e.decimal_comma="decimal_comma",e.space_comma="space_comma",e.none="none"}(rn||(rn={})),function(e){e.language="language",e.system="system",e.am_pm="12",e.twenty_four="24"}(an||(an={}));class nn{static getCropStyle(e,t){return t?`\n      background-image: url('${e}');\n      background-size: ${100*t.scale}%;\n      background-position: ${t.x}% ${t.y}%;\n    `:`background-image: url('${e}')`}static renderAddPlantDialog(e,t,r,i){if(!e?.open)return G``;const a=[...new Set(t.map(e=>e.strain))].sort(),n=nn.getTimelineContent(e,r,i);return G`
        ...
        <div class="glass-dialog-container" style="--stage-color: var(--plant-border-color-default)">
          ...
          <div class="overview-grid">
             ...
             <div class="detail-card">
               ...
               ${nn.renderMD3SelectInput("Strain *",e.strain||"",a,i.onStrainChange)}
               ${nn.renderMD3TextInput("Phenotype",e.phenotype||"",i.onPhenotypeChange)}
               <div style="display:flex; gap:16px;">
                 ${nn.renderMD3NumberInput("Row",e.row+1,e=>i.onRowChange(e))}
                 ${nn.renderMD3NumberInput("Col",e.col+1,e=>i.onColChange(e))}
               </div>
             </div>
    ...
    `}static getTimelineContent(e,t,r){const i=t.toLowerCase();let a;return a=i.includes("mother")?G`${nn.renderMD3DateInput("Mother Start",e.mother_start||"",r.onMotherStartChange)}`:i.includes("clone")?G`${nn.renderMD3DateInput("Clone Start",e.clone_start||"",r.onCloneStartChange)}`:i.includes("dry")?G`${nn.renderMD3DateInput("Dry Start",e.dry_start||"",r.onDryStartChange)}`:i.includes("cure")?G`${nn.renderMD3DateInput("Cure Start",e.cure_start||"",r.onCureStartChange)}`:G`
        ${nn.renderMD3DateInput("Seedling Start",e.seedling_start||"",r.onSeedlingStartChange)}
        ${nn.renderMD3DateInput("Vegetative Start",e.veg_start||"",r.onVegStartChange)}
        ${nn.renderMD3DateInput("Flower Start",e.flower_start||"",r.onFlowerStartChange)}
      `,G`
      <h3>Timeline</h3>
      ${a}
    `}static renderPlantOverviewDialog(e,t,r){if(!e?.open)return G``;const{plant:i,editedAttributes:a}=e,n=i.attributes?.plant_id||i.entity_id.replace("sensor.",""),s=en.getPlantStageColor(i.state),o=en.getPlantStageIcon(i.state),l=(e,t)=>{a[e]="number"==typeof t?t.toString():t,r.onAttributeChange(e,a[e])};return G`
      <ha-dialog
        open
        @closed=${r.onClose}
        hideActions
      ...
      >
        <div class="glass-dialog-container" style="--stage-color: ${s}">
          ...
          <div class="overview-grid">
             ...
             <div class="detail-card">
               <h3>Identity & Location</h3>
               ${nn.renderMD3TextInput("Strain Name",a.strain||"",e=>r.onAttributeChange("strain",e))}
               ${nn.renderMD3TextInput("Phenotype",a.phenotype||"",e=>r.onAttributeChange("phenotype",e))}
               <div style="display:flex; gap:16px;">
                 ${nn.renderMD3NumberInput("Row",a.row||1,e=>r.onAttributeChange("row",parseInt(e)))}
                 ${nn.renderMD3NumberInput("Col",a.col||1,e=>r.onAttributeChange("col",parseInt(e)))}
               </div>
             </div>
             ...
             <div class="detail-card">
               <h3>Timeline</h3>
               ${"mother"===a.stage?nn.renderMD3DateInput("Mother Start",a.mother_start??"",e=>l("mother_start",e)):Z}
               ${"clone"===a.stage?nn.renderMD3DateInput("Clone Start",a.clone_start??"",e=>l("clone_start",e)):Z}
               ${"veg"===a.stage||"flower"===a.stage?nn.renderMD3DateInput("Vegetative Start",a.veg_start??"",e=>l("veg_start",e)):Z}
               ${"flower"===a.stage?nn.renderMD3DateInput("Flower Start",a.flower_start??"",e=>l("flower_start",e)):Z}
               ${"dry"===a.stage||"cure"===a.stage?nn.renderMD3DateInput("Dry Start",a.dry_start??"",e=>l("dry_start",e)):Z}
               ${"cure"===a.stage?nn.renderMD3DateInput("Cure Start",a.cure_start??"",e=>l("cure_start",e)):Z}
             </div>

             <!-- STATS CARD -->
             ${nn.renderPlantStatsMD3(i)}
    ...
    `}static renderStrainCard(e,t){let r=De,i=e.type||"Unknown";const a=(e.type||"").toLowerCase();a.includes("indica")?r=Ie:a.includes("sativa")?r=Ne:a.includes("hybrid")?r=Le:(a.includes("ruderalis")||a.includes("auto"))&&(r=De);const n=e.image?nn.getCropStyle(e.image,e.image_crop_meta):"";return G`
         ...
         <div class="editor-layout">
            ...
            <div class="editor-col">
               <div class="photo-upload-area"
                    ...
                    @drop=${e=>{e.preventDefault();const t=e.dataTransfer?.files[0];t&&en.compressImage(t).then(e=>a("image",e)).catch(e=>console.error("Error compressing image:",e))}}>
                  ...
                  ${r.image?G`
                     ${r.image_crop_meta?G`<div style="width:100%; height:100%; border-radius:10px; ${nn.getCropStyle(r.image,r.image_crop_meta)}; background-repeat: no-repeat;"></div>`:G`<img src="${r.image}" style="width:100%; height:100%; object-fit:cover; border-radius:10px;" />`}
                  ...
                  <input type="file" id="strain-image-upload" style="display:none" accept="image/*"
                         @change=${e=>{const t=e.target.files?.[0];t&&en.compressImage(t).then(e=>a("image",e)).catch(e=>console.error("Error compressing image:",e))}} />
               </div>
            ...
            <div class="editor-col">
               <div class="sd-form-group">
                  ...
                  <div class="type-selector-grid">
                     ${["Indica","Sativa","Hybrid","Ruderalis"].map(e=>{let t=De;"Indica"===e&&(t=Ie),"Sativa"===e&&(t=Ne),"Hybrid"===e&&(t=Le);const i=(r.type||"").toLowerCase()===e.toLowerCase();return G`
    ...
    `}static renderMD3DateInput(e,t,r){const i=en.toDateTimeLocal(t);return G`
      <div class="md3-input-group">
        <label class="md3-label">${e}</label>
        <input
          type="datetime-local"
    ...
    `:G``}static renderScheduleSection(e,t,r,i,a,n,s){const o="irrigation"===n?a.onAddIrrigationTime:a.onAddDrainTime,l="irrigation"===n?a.onRemoveIrrigationTime:a.onRemoveDrainTime,c="irrigation"===n?a.onStartAddingIrrigationTime:a.onStartAddingDrainTime,d="irrigation"===n?a.onCancelAddingIrrigationTime:a.onCancelAddingDrainTime,p="irrigation"===n?a.onConfirmAddIrrigationTime:a.onConfirmAddDrainTime,u="irrigation"===n?a.onIrrigationTimeInputChange:a.onDrainTimeInputChange,h="irrigation"===n?i.adding_irrigation_time:i.adding_drain_time;return G`
         <div class="detail-card">
            ...
            <div
               class="${n}-time-bar"
               @click=${e=>{const t=e.currentTarget.getBoundingClientRect(),r=e.clientX-t.left;c(r,t.width)}}
               style="position: relative; height: 80px; background: rgba(0,0,0,0.3); border-radius: 8px; cursor: crosshair; border: 2px solid ${s}40;"
            >
               ${Array.from({length:25},(e,t)=>t).map(e=>G`
               ...
               ${t.map(e=>{const[t,i]=e.time.split(":").map(Number);return G`
                     <div
                        @click=${t=>{t.stopPropagation(),confirm(`Remove ${n} time ${e.time}?`)&&l(e.time)}}
                        style="position: absolute; left: ${(t+i/60)/24*100}%; top: 10%; bottom: 10%; width: 4px; background: ${s}; cursor: pointer; box-shadow: 0 0 8px ${s}; border-radius: 2px;"
                        title="${e.time} | Duration: ${e.duration||r}min"
                     >
                  ...
                  <div class="detail-card" style="max-width: 400px; margin: 0;" @click=${e=>e.stopPropagation()}>
                     ...
                     <div class="md3-input-group">
                        ...
                        <input
                           ...
                           @input=${e=>{const t=parseInt(e.target.value);isNaN(t)||u("duration",t)}}
                           min="1"
                        />
                     </div>
      ...
      `}static renderIrrigationDialog(e,t){if(!e?.open)return Z;const r="#2196F3";return G`
         <ha-dialog
            open
            @closed=${t.onClose}
            hideActions
            ...
            .escapeKeyAction=${""}
         >
            <div class="glass-dialog-container" style="--stage-color: ${r}; max-width: 1000px; max-height: 90vh; overflow-y: auto;">

               <div class="dialog-header">
                  <div class="dialog-icon" style="background: ${r}30; color: ${r};">
                     <svg style="width:32px;height:32px;fill:currentColor;" viewBox="0 0 24 24">
                        <path d="${Oe}"></path>
                     </svg>
                  </div>
               ...
               <div class="dialog-body" style="padding: 0; background: transparent;">
                  ...
                  <div class="detail-card">
                     ...
                     <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                        ${this.renderMD3TextInput("Irrigation Pump Entity",e.irrigation_pump_entity,t.onIrrigationPumpChange)}
                        ${this.renderMD3NumberInput("Duration (minutes)",e.irrigation_duration,e=>t.onIrrigationDurationChange(parseInt(e)))}
                        ${this.renderMD3TextInput("Drain Pump Entity",e.drain_pump_entity,t.onDrainPumpChange)}
                        ${this.renderMD3NumberInput("Drain Duration (minutes)",e.drain_duration,e=>t.onDrainDurationChange(parseInt(e)))}
                     </div>

                     <button
                        @click=${t.onSavePumpSettings}
                        class="md3-button primary"
                        style="margin-top: 16px; background: ${r};"
                     >
                        SAVE PUMP SETTINGS
                     </button>
                  </div>

                  ${this.renderScheduleSection("Irrigation Schedule",e.irrigation_times,e.irrigation_duration,e,t,"irrigation",r)}

                           ${this.renderScheduleSection("Drain Schedule",e.drain_times,e.drain_duration,e,t,"drain","#FF9800")}
      ...
      <div class="gs-env-graph-card" style="margin-top: 12px; background: #1a1a1a; border-radius: 12px; padding: 16px;">
         ...
         <div class="gs-env-chart-container" style="position: relative; height: 180px; background: #0d0d0d; border-radius: 8px; padding: 20px 40px 30px 50px;"
             ...
             <div style="position: absolute; left: 0; top: 20px; bottom: 30px; width: 45px; display: flex; flex-direction: column; justify-content: space-between; font-size: 0.65rem; color: #666; text-align: right; padding-right: 8px;">
                ${b.map(e=>G`<div>${e.toFixed(1)} ${i}</div>`)}
             </div>
            ...
            <div class="gs-title-group">
               ...
               <div style="display: flex; gap: 8px;">
                <div class="gs-stage-chip">
                  <svg style="width:16px;height:16px;fill:currentColor;" viewBox="0 0 24 24"><path d="${en.getPlantStageIcon(t.stage)}"></path></svg>
            ...
            <div class="gs-stats-chips">
                ${void 0!==c?G`
                   <div class="stat-chip ${this._activeEnvGraphs.has("temperature")?"active":""}"
                     ...
                     <svg viewBox="0 0 24 24"><path d="${Te}"></path></svg>${c}°C
                   </div>`:""}
                ${void 0!==d?G`
...
<!-- Active Environmental Graphs -->
  ...
  `}renderHeader(e){return this._isCompactView||this._config?.title?(e.find(e=>e.device_id===this.selectedDevice),G`
    ...
    `}renderPlantSlot(e,t,r,i){const a=en.getPlantStageColor(e.state),n=e.attributes?.strain,s=e.attributes?.phenotype;let o;if(n){const e=i.find(e=>e.strain===n&&e.phenotype===s);if(e&&e.image)o=e.image;else{const e=i.find(e=>e.strain===n&&(!e.phenotype||"default"===e.phenotype));if(e&&e.image)o=e.image;else if(!o){const e=i.find(e=>e.strain===n&&e.image);e&&(o=e.image)}}}const l=o?`background-image: url('${o}');`:"";return G`
      <div
    ...
    `}renderPlantDaysRich(e){const t=[{days:e.attributes?.seedling_days,icon:Me,title:"Seedling",stage:"seedling"},{days:e.attributes?.mother_days,icon:Me,title:"Mother",stage:"mother"},{days:e.attributes?.clone_days,icon:Me,title:"Clone",stage:"clone"},{days:e.attributes?.veg_days,icon:Me,title:"Veg",stage:"vegetative"},{days:e.attributes?.flower_days,icon:$e,title:"Flower",stage:"flower"},{days:e.attributes?.dry_days,icon:Se,title:"Dry",stage:"dry"},{days:e.attributes?.cure_days,icon:me,title:"Cure",stage:"cure"}].filter(e=>void 0!==e.days&&null!==e.days),r=t.filter(e=>e.days),i=(e.state||"").toLowerCase(),a="veg"===i?"vegetative":i;return G`
        ${r.map(e=>{const t=en.getPlantStageColor(e.stage),r=e.stage===a;return G`
    ...
    `],e([he(),t("design:type",Object)],sn.prototype,"_addPlantDialog",void 0),e([he(),t("design:type",Object)],sn.prototype,"_defaultApplied",void 0),e([he(),t("design:type",Object)],sn.prototype,"_plantOverviewDialog",void 0),e([he(),t("design:type",Object)],sn.prototype,"_strainLibraryDialog",void 0),e([he(),t("design:type",Object)],sn.prototype,"_configDialog",void 0),e([he(),t("design:type",Object)],sn.prototype,"_growMasterDialog",void 0),e([he(),t("design:type",Object)],sn.prototype,"_strainRecommendationDialog",void 0),e([he(),t("design:type",Object)],sn.prototype,"_irrigationDialog",void 0),e([he(),t("design:type",Object)],sn.prototype,"selectedDevice",void 0),e([he(),t("design:type",Object)],sn.prototype,"_draggedPlant",void 0),e([he(),t("design:type",Boolean)],sn.prototype,"_isCompactView",void 0),e([he(),t("design:type",Object)],sn.prototype,"_historyData",void 0),e([he(),t("design:type",Set)],sn.prototype,"_activeEnvGraphs",void 0),e([he(),t("design:type",Object)],sn.prototype,"_tooltip",void 0),e([he(),t("design:type",Boolean)],sn.prototype,"_menuOpen",void 0),e([ue({attribute:!1}),t("design:type",Object)],sn.prototype,"hass",void 0),e([ue({attribute:!1}),t("design:type",Object)],sn.prototype,"_config",void 0),sn=e([ce("growspace-manager-card")],sn);let on=class extends oe{constructor(){super(...arguments),this._growspaceOptions=[]}setConfig(e){this._config=e,this._loadGrowspaces()}updated(e){e.has("hass")&&this.hass&&(this._loadGrowspaces(),this._subscribeToSensorUpdates())}disconnectedCallback(){super.disconnectedCallback(),this._unsubStateChanged&&(this._unsubStateChanged(),this._unsubStateChanged=void 0)}_subscribeToSensorUpdates(){this.hass&&!this._unsubStateChanged&&(this._unsubStateChanged=this.hass.connection.subscribeEvents(e=>{const t=e.data.new_state;"sensor.growspaces_list"===t?.entity_id&&(Array.isArray(t.attributes?.growspaces)?this._growspaceOptions=t.attributes.growspaces:this._growspaceOptions=[])},"state_changed"))}_loadGrowspaces(){if(!this.hass)return;const e=this.hass.states["sensor.growspaces_list"];if(e&&e.attributes?.growspaces){const t=e.attributes.growspaces;this._growspaceOptions=Object.values(t)}else this._growspaceOptions=[]}render(){return this._config?G`
      <div class="form-group">
    ...
    `:G``}_valueChanged(e,t){if(!this._config)return;const r={...this._config,[e]:t};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:r},bubbles:!0,composed:!0}))}};on.styles=o`
    .form-group {
      margin-bottom: 12px;
    }
    label {
  ...
  `,e([ue({attribute:!1}),t("design:type",Object)],on.prototype,"hass",void 0),e([ue({attribute:!1}),t("design:type",Object)],on.prototype,"_config",void 0),e([he(),t("design:type",Array)],on.prototype,"_growspaceOptions",void 0),on=e([ce("growspace-manager-card-editor")],on);var ln=Object.freeze({__proto__:null,get GrowspaceManagerCardEditor(){return on}});export{sn as GrowspaceManagerCard};
