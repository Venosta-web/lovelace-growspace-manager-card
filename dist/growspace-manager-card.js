...
`;class Xa{static normalizeStage(e){const t=e.toLowerCase();return"veg"===t?"vegetative":"mom"===t?"mother":t}static getPlantStageColor(e){const t=this.normalizeStage(e);return this.stageColors[t]??"#757575"}static getPlantStageIcon(e){const t=this.normalizeStage(e);return this.stageIcons[t]??Me}static getPlantStage(e){const t=e?.attributes??{},r=new Date;return t.cure_start?"cure":t.dry_start?"dry":t.mom_start?"mother":t.clone_start?"clone":t.flower_start&&new Date(t.flower_start)<=r?"flower":t.veg_start&&new Date(t.veg_start)<=r?"vegetative":"seedling"}static createGridLayout(e,t,r){const i=Array.from({length:t},()=>Array.from({length:r},()=>null));return e.forEach(e=>{const a=(e.attributes?.row??1)-1,s=(e.attributes?.col??1)-1;a>=0&&a<t&&s>=0&&s<r&&(i[a][s]=e)}),{rows:t,cols:r,grid:i}}static calculateEffectiveRows(e){const{name:t,plants:r,plants_per_row:i,rows:a}=e;if("dry"===t||"cure"===t||"mother"===t||"clone"===t){if(0===r.length)return 1;const e=Math.max(...r.map(e=>e.attributes?.row||1)),t=r.filter(t=>(t.attributes?.row||1)===e).length;return t>=i?e+1:e}return a}static parseDateTimeLocal(e){if(e)try{const t=16===e.length?e+":00":e,r=new Date(t);if(isNaN(r.getTime()))return;const i=r.getFullYear(),a=String(r.getMonth()+1).padStart(2,"0"),s=String(r.getDate()).padStart(2,"0"),n=String(r.getHours()).padStart(2,"0"),o=String(r.getMinutes()).padStart(2,"0");return`${i}-${a}-${s}T${n}:${o}:${String(r.getSeconds()).padStart(2,"0")}`}catch{return}}static formatDateForBackend(e){if(e)try{const t=e.split("T");if(t.length>0&&t[0].match(/^\d{4}-\d{2}-\d{2}$/))return t[0];const r=new Date(e);if(isNaN(r.getTime()))return;const i=r.getFullYear(),a=String(r.getMonth()+1).padStart(2,"0");return`${i}-${a}-${String(r.getDate()).padStart(2,"0")}`}catch{return}}static getCurrentDateTime(){const e=new Date,t=e=>e.toString().padStart(2,"0");return`${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}T${t(e.getHours())}:${t(e.getMinutes())}:00`}static toDateTimeLocal(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const r=e=>e.toString().padStart(2,"0"),i=t.getFullYear(),a=r(t.getMonth()+1),s=r(t.getDate()),n=r(t.getHours());return`${i}-${a}-${s}T${n}:${r(t.getMinutes())}`}catch{return""}}static getDominantStage(e){if(!e||0===e.length)return null;const t=["cure","dry","flower","vegetative","clone","mother","seedling"];let r=null,i=0;const a={};for(const t of e){const e=this.normalizeStage(t.state||this.getPlantStage(t));a[e]||(a[e]=[]),a[e].push(t)}for(const e of t)if(a[e]&&a[e].length>0){r=e;const t=`${"vegetative"===e?"veg":e}_days`,s=a[e].map(e=>{const r=e.attributes[t];return"number"==typeof r?r:0});i=Math.max(...s);break}return r?{stage:r,days:i}:null}static compressImage(e,t=800,r=800,i=.7){return new Promise((a,s)=>{const n=new FileReader;n.readAsDataURL(e),n.onload=e=>{const n=new Image;n.src=e.target?.result,n.onload=()=>{let e=n.width,o=n.height;e>o?e>t&&(o=Math.round(o*t/e),e=t):o>r&&(e=Math.round(e*r/o),o=r);const l=document.createElement("canvas");l.width=e,l.height=o;const c=l.getContext("2d");if(!c)return void s(new Error("Failed to get canvas context"));c.drawImage(n,0,0,e,o);const d=l.toDataURL("image/jpeg",i);a(d)},n.onerror=e=>s(e)},n.onerror=e=>s(e)})}}Xa.stageColors={mother:"#E91E63",clone:"#FF5722",seedling:"#4CAF50",vegetative:"#8BC34A",flower:"#FF9800",dry:"#795548",cure:"#9C27B0"},Xa.stageIcons={mother:Me,clone:Me,seedling:Me,vegetative:Me,flower:$e,dry:Se,cure:me};class es{constructor(e){this.hass=e}getGrowspaceDevices(){if(!this.hass)return[];const e=Object.values(this.hass.states),t=e.filter(e=>e.entity_id.startsWith("sensor.")&&void 0!==e.attributes?.growspace_id&&void 0!==e.attributes?.rows&&void 0!==e.attributes?.plants_per_row&&void 0===e.attributes?.row&&void 0===e.attributes?.col),r=new Map;return t.forEach(e=>{const t=e.attributes.growspace_id;r.set(t,[])}),e.forEach(e=>{if(void 0!==e.attributes?.row&&void 0!==e.attributes?.col){const t=this.getGrowspaceId(e);r.has(t)||r.set(t,[]),r.get(t).push(e)}}),Array.from(r.entries()).map(([e,r])=>{const i=t.find(t=>t.attributes?.growspace_id===e),a=i?.attributes?.friendly_name||`Growspace ${e}`,s=i?.attributes?.type??(a.toLowerCase().includes("dry")?"dry":a.toLowerCase().includes("cure")?"cure":"normal");return n={device_id:e,overview_entity_id:i?.entity_id,name:a,plants:r,rows:i?.attributes?.rows??3,plants_per_row:i?.attributes?.plants_per_row??3,type:s},{...n,type:n.type??"normal"};var n})}getGrowspaceId(e){return e.attributes?.growspace_id||"unknown"}getStrainLibrary(){const e=Object.values(this.hass.states).find(e=>void 0!==e.attributes?.strains&&null!==e.attributes?.strains),t=e?.attributes?.strains;if(!t)return[];if(Array.isArray(t))return t.map(e=>({strain:e,phenotype:"",key:`${e}|default`}));if("object"==typeof t){const e=[];for(const[r,i]of Object.entries(t)){const t=i,a=t.analytics,s=t.meta||{};if(t.phenotypes&&"object"==typeof t.phenotypes){const i=Object.entries(t.phenotypes);if(i.length>0)for(const[t,n]of i){const i=n;let o;i.analytics?o=i.analytics:"number"==typeof i.avg_veg_days&&(o={avg_veg_days:i.avg_veg_days,avg_flower_days:i.avg_flower_days,total_harvests:i.total_harvests}),e.push({strain:r,phenotype:t,key:`${r}|${t}`,analytics:o,strain_analytics:a,image_crop_meta:i.image_crop_meta,breeder:i.breeder||s.breeder,type:i.type||s.type,lineage:i.lineage||s.lineage,sex:i.sex||s.sex,description:i.description||s.description,flowering_days_min:i.flower_days_min||s.flowering_days_min,flowering_days_max:i.flower_days_max||s.flowering_days_max,image:i.image_path||i.image||s.image,sativa_percentage:i.sativa_percentage||s.sativa_percentage,indica_percentage:i.indica_percentage||s.indica_percentage})}else e.push({strain:r,phenotype:"",key:`${r}|default`,strain_analytics:a,image_crop_meta:t.image_crop_meta,breeder:s.breeder,type:s.type,lineage:s.lineage,sex:s.sex,description:s.description,flowering_days_min:s.flowering_days_min,flowering_days_max:s.flowering_days_max,image:s.image,sativa_percentage:s.sativa_percentage,indica_percentage:s.indica_percentage})}else e.push({strain:r,phenotype:"",key:`${r}|default`,strain_analytics:a,image_crop_meta:t.image_crop_meta,breeder:s.breeder,type:s.type,lineage:s.lineage,sex:s.sex,description:s.description,flowering_days_min:s.flowering_days_min,flowering_days_max:s.flowering_days_max,image:s.image,sativa_percentage:s.sativa_percentage,indica_percentage:s.indica_percentage})}return e.sort((e,t)=>{const r=e.strain.localeCompare(t.strain);return 0!==r?r:(e.phenotype||"").localeCompare(t.phenotype||"")})}return[]}async getHistory(e,t,r){if(!this.hass)return[];let i=`history/period/${t.toISOString()}?filter_entity_id=${e}`;r&&(i+=`&end_time=${r.toISOString()}`);try{const e=await this.hass.callApi("GET",i);return e&&e.length>0?e[0]:[]}catch(e){return console.error("Error fetching history:",e),[]}}async addPlant(e){console.log("[DataService:addPlant] Sending payload:",e);try{"mother"!==e.growspace_id&&"mother_overview"!==e.growspace_id||(e.mother_start=(new Date).toISOString().split("T")[0]),"clone"!==e.growspace_id&&"clone_overview"!==e.growspace_id||(e.clone_start=(new Date).toISOString().split("T")[0]);const t=await this.hass.callService("growspace_manager","add_plant",e);return console.log("[DataService:addPlant] Response:",t),t}catch(e){throw console.error("[DataService:addPlant] Error:",e),e}}async updatePlant(e){console.log("[DataService:updatePlant] Sending payload:",e);try{const t=await this.hass.callService("growspace_manager","update_plant",e);return console.log("[DataService:updatePlant] Response:",t),t}catch(e){throw console.error("[DataService:updatePlant] Error:",e),e}}async removePlant(e){console.log("[DataService:removePlant] Removing plant_id:",e);try{const t=await this.hass.callService("growspace_manager","remove_plant",{plant_id:e});return console.log("[DataService:removePlant] Response:",t),t}catch(e){throw console.error("[DataService:removePlant] Error:",e),e}}async harvestPlant(e,t="dry"){console.log("[DataService:harvestPlant] Harvesting plant:",e,"→ target:",t);try{const r=(t||"").toLowerCase(),i={plant_id:e};r.includes("dry")?i.target_growspace_id="dry_overview":r.includes("cure")?i.target_growspace_id="cure_overview":r.includes("mother")?i.target_growspace_id="mother_overview":r.includes("clone")?i.target_growspace_id="clone_overview":r&&(i.target_growspace_name=t);const a=await this.hass.callService("growspace_manager","harvest_plant",i);return console.log("[DataService:harvestPlant] Response:",a),a}catch(e){throw console.error("[DataService:harvestPlant] Error:",e),e}}async takeClone(e,t="clone"){console.log("[DataService:takeClone] Cloning plant:",e,"→ target:",t);try{const r=(t||"").toLowerCase(),i={plant_id:e};r.includes("dry")?i.target_growspace_id="dry_overview":r.includes("cure")?i.target_growspace_id="cure_overview":r.includes("mother")?i.target_growspace_id="mother_overview":r.includes("clone")?i.target_growspace_id="clone_overview":r&&(i.target_growspace_name=t);const a=await this.hass.callService("growspace_manager","takeClone",i);return console.log("[DataService:takeClone] Response:",a),a}catch(e){throw console.error("[DataService:takeClone] Error:",e),e}}async swapPlants(e,t){console.log(`[DataService:swapPlants] Swapping plants: ${e} and ${t}`);try{const r=await this.hass.callService("growspace_manager","switch_plants",{plant1_id:e,plant2_id:t});return console.log("[DataService:swapPlants] Response:",r),r}catch(e){throw console.error("[DataService:swapPlants] Error:",e),e}}async addStrain(e){console.log("[DataService:addStrain] Adding strain:",e);try{const t={...e};Object.keys(t).forEach(e=>{void 0===t[e]&&delete t[e]}),e.image&&(e.image.startsWith("data:")?(t.image_base64=e.image,delete t.image):(t.image_path=e.image,delete t.image));const r=await this.hass.callService("growspace_manager","add_strain",t);return console.log("[DataService:addStrain] Response:",r),r}catch(e){throw console.error("[DataService:addStrain] Error:",e),e}}async removeStrain(e,t){console.log("[DataService:removeStrain] Removing strain:",e,t);try{const r=await this.hass.callService("growspace_manager","remove_strain",{strain:e,phenotype:t});return console.log("[DataService:removeStrain] Response:",r),r}catch(e){throw console.error("[DataService:removeStrain] Error:",e),e}}async importStrainLibrary(e,t){console.log("[DataService:importStrainLibrary] Importing strain library ZIP via HTTP. Replace:",t);const r=new FormData;r.append("file",e),r.append("replace",t.toString());try{const e=await fetch("/api/growspace_manager/import_strains",{method:"POST",body:r,headers:{Authorization:`Bearer ${this.hass.auth.data.access_token}`}});if(!e.ok){const t=await e.text();throw new Error(t||e.statusText)}const t=await e.json();if(console.log("[DataService:importStrainLibrary] Response:",t),t.success)return t;throw new Error(t.error||"Unknown import error")}catch(e){throw console.error("[DataService:importStrainLibrary] Error:",e),e}}async clearStrainLibrary(){console.log("[DataService:clearStrainLibrary] Clearing library");try{const e=await this.hass.callService("growspace_manager","clear_strain_library");return console.log("[DataService:clearStrainLibrary] Response:",e),e}catch(e){throw console.error("[DataService:clearStrainLibrary] Error:",e),e}}async addGrowspace(e){console.log("[DataService:addGrowspace] Adding growspace:",e);try{const t=await this.hass.callService("growspace_manager","add_growspace",e);return console.log("[DataService:addGrowspace] Response:",t),t}catch(e){throw console.error("[DataService:addGrowspace] Error:",e),e}}async configureGrowspaceSensors(e){console.log("[DataService:configureGrowspaceSensors] Configuring sensors:",e);try{const t=await this.hass.callService("growspace_manager","configure_growspace",e);return console.log("[DataService:configureGrowspaceSensors] Response:",t),t}catch(e){throw console.error("[DataService:configureGrowspaceSensors] Error:",e),e}}async configureGlobalSettings(e){console.log("[DataService:configureGlobalSettings] Configuring global settings:",e);try{const t=await this.hass.callService("growspace_manager","configure_global",e);return console.log("[DataService:configureGlobalSettings] Response:",t),t}catch(e){throw console.error("[DataService:configureGlobalSettings] Error:",e),e}}async askGrowAdvice(e,t){console.log("[DataService:askGrowAdvice] Asking advice for:",e,t);try{return await this.hass.connection.sendMessagePromise({type:"call_service",domain:"growspace_manager",service:"ask_grow_advice",service_data:{growspace_id:e,user_query:t},return_response:!0})}catch(e){throw console.error("[DataService:askGrowAdvice] Error:",e),e}}async analyzeAllGrowspaces(){console.log("[DataService:analyzeAllGrowspaces] Analyzing all growspaces");try{return await this.hass.connection.sendMessagePromise({type:"call_service",domain:"growspace_manager",service:"analyze_all_growspaces",service_data:{},return_response:!0})}catch(e){throw console.error("[DataService:analyzeAllGrowspaces] Error:",e),e}}async getStrainRecommendation(e){console.log("[DataService:getStrainRecommendation] Getting strain recommendation for:",e);try{return await this.hass.connection.sendMessagePromise({type:"call_service",domain:"growspace_manager",service:"strain_recommendation",service_data:{user_query:e},return_response:!0})}catch(e){throw console.error("[DataService:getStrainRecommendation] Error:",e),e}}}var ts,rs;!function(e){e.language="language",e.system="system",e.comma_decimal="comma_decimal",e.decimal_comma="decimal_comma",e.space_comma="space_comma",e.none="none"}(ts||(ts={})),function(e){e.language="language",e.system="system",e.am_pm="12",e.twenty_four="24"}(rs||(rs={}));class is{static getCropStyle(e,t){return t?`\n      background-image: url('${e}');\n      background-size: ${100*t.scale}%;\n      background-position: ${t.x}% ${t.y}%;\n    `:`background-image: url('${e}')`}static renderAddPlantDialog(e,t,r,i){if(!e?.open)return j``;const a=[...new Set(t.map(e=>e.strain))].sort(),s=is.getTimelineContent(e,r,i);return j`
        ...
        <div class="glass-dialog-container" style="--stage-color: var(--plant-border-color-default)">
          ...
          <div class="overview-grid">
             ...
             <div class="detail-card">
               ...
               ${is.renderMD3SelectInput("Strain *",e.strain||"",a,i.onStrainChange)}
               ${is.renderMD3TextInput("Phenotype",e.phenotype||"",i.onPhenotypeChange)}
               <div style="display:flex; gap:16px;">
                 ${is.renderMD3NumberInput("Row",e.row+1,e=>i.onRowChange(e))}
                 ${is.renderMD3NumberInput("Col",e.col+1,e=>i.onColChange(e))}
               </div>
             </div>
    ...
    `}static getTimelineContent(e,t,r){const i=t.toLowerCase();let a;return a=i.includes("mother")?j`${is.renderMD3DateInput("Mother Start",e.mother_start||"",r.onMotherStartChange)}`:i.includes("clone")?j`${is.renderMD3DateInput("Clone Start",e.clone_start||"",r.onCloneStartChange)}`:i.includes("dry")?j`${is.renderMD3DateInput("Dry Start",e.dry_start||"",r.onDryStartChange)}`:i.includes("cure")?j`${is.renderMD3DateInput("Cure Start",e.cure_start||"",r.onCureStartChange)}`:j`
        ${is.renderMD3DateInput("Seedling Start",e.seedling_start||"",r.onSeedlingStartChange)}
        ${is.renderMD3DateInput("Vegetative Start",e.veg_start||"",r.onVegStartChange)}
        ${is.renderMD3DateInput("Flower Start",e.flower_start||"",r.onFlowerStartChange)}
      `,j`
      <h3>Timeline</h3>
      ${a}
    `}static renderPlantOverviewDialog(e,t,r){if(!e?.open)return j``;const{plant:i,editedAttributes:a}=e,s=i.attributes?.plant_id||i.entity_id.replace("sensor.",""),n=Xa.getPlantStageColor(i.state),o=Xa.getPlantStageIcon(i.state),l=(e,t)=>{a[e]="number"==typeof t?t.toString():t,r.onAttributeChange(e,a[e])};return j`
      <ha-dialog
        open
        @closed=${r.onClose}
        hideActions
      ...
      >
        <div class="glass-dialog-container" style="--stage-color: ${n}">
          ...
          <div class="overview-grid">
             ...
             <div class="detail-card">
               <h3>Identity & Location</h3>
               ${is.renderMD3TextInput("Strain Name",a.strain||"",e=>r.onAttributeChange("strain",e))}
               ${is.renderMD3TextInput("Phenotype",a.phenotype||"",e=>r.onAttributeChange("phenotype",e))}
               <div style="display:flex; gap:16px;">
                 ${is.renderMD3NumberInput("Row",a.row||1,e=>r.onAttributeChange("row",parseInt(e)))}
                 ${is.renderMD3NumberInput("Col",a.col||1,e=>r.onAttributeChange("col",parseInt(e)))}
               </div>
             </div>
             ...
             <div class="detail-card">
               <h3>Timeline</h3>
               ${"mother"===a.stage?is.renderMD3DateInput("Mother Start",a.mother_start??"",e=>l("mother_start",e)):Z}
               ${"clone"===a.stage?is.renderMD3DateInput("Clone Start",a.clone_start??"",e=>l("clone_start",e)):Z}
               ${"veg"===a.stage||"flower"===a.stage?is.renderMD3DateInput("Vegetative Start",a.veg_start??"",e=>l("veg_start",e)):Z}
               ${"flower"===a.stage?is.renderMD3DateInput("Flower Start",a.flower_start??"",e=>l("flower_start",e)):Z}
               ${"dry"===a.stage||"cure"===a.stage?is.renderMD3DateInput("Dry Start",a.dry_start??"",e=>l("dry_start",e)):Z}
               ${"cure"===a.stage?is.renderMD3DateInput("Cure Start",a.cure_start??"",e=>l("cure_start",e)):Z}
             </div>

             <!-- STATS CARD -->
             ${is.renderPlantStatsMD3(i)}
    ...
    `:j``}static renderImportDialog(e,t){const r=e.importDialog?.replace||!1;return j`
     ...
     `}static renderImageSelector(e,t){const r=new Map;return e.strains.forEach(e=>{e.image&&(r.has(e.image)||r.set(e.image,[]),r.get(e.image).push({strain:e.strain,phenotype:e.phenotype||""}))}),j`
        <div class="crop-overlay">
           <div style="background: #1a1a1a; width: 80%; max-width: 800px; height: 80%; max-height: 600px; border-radius: 16px; display: flex; flex-direction: column; overflow: hidden; border: 1px solid var(--border-color);">
              ...
              <div class="sd-content" style="overflow-y: auto;">
                 ...
                 ${0===r.size?j`<p style="text-align: center; color: var(--text-secondary); margin-top: 40px;">No images found in library.</p>`:Z}
              </div>
           </div>
        </div>
     `}static renderCropOverlay(e,t){const r=e.editorState;if(!r.image)return Z;const i=r.image_crop_meta||{x:50,y:50,scale:1};return j`
       <div class="crop-overlay">
    ...
    `}static renderStrainBrowseView(e,t){const r=(e.searchQuery||"").toLowerCase(),i=e.strains.filter(e=>e.strain.toLowerCase().includes(r)||e.breeder&&e.breeder.toLowerCase().includes(r)||e.phenotype&&e.phenotype.toLowerCase().includes(r));return j`
      <div class="sd-header">
    ...
    `}static renderStrainCard(e,t){let r=De,i=e.type||"Unknown";const a=(e.type||"").toLowerCase();a.includes("indica")?r=Oe:a.includes("sativa")?r=Ie:a.includes("hybrid")?r=Te:(a.includes("ruderalis")||a.includes("auto"))&&(r=De);const s=e.image?is.getCropStyle(e.image,e.image_crop_meta):"";return j`
       <div class="strain-card" @click=${()=>t.onSwitchView("editor",e)}>
          <div class="sc-thumb" style="${e.image?s+"; background-repeat: no-repeat; background-position: center; background-size: cover;":""}">
             ${e.image?e.image_crop_meta?j`<div style="width:100%; height:100%; ${s}; background-repeat: no-repeat;"></div>`:j`<img src="${e.image}" alt="${e.strain}" />`:j`<svg style="width:48px;height:48px;opacity:0.2;fill:currentColor;" viewBox="0 0 24 24"><path d="${me}"></path></svg>`}
     ...
     `}static renderStrainEditorView(e,t){const r=e.editorState||{},i=!!r.strain&&e.strains.some(e=>e.strain===r.strain&&e.phenotype===r.phenotype),a=(e,r)=>t.onEditorChange(e,r),s=[...new Set(e.strains.map(e=>e.strain).filter(Boolean))].sort(),n=[...new Set(e.strains.map(e=>e.breeder).filter(Boolean))].sort();return j`
         ...
         <div class="editor-layout">
            ...
            <div class="editor-col">
               <div class="photo-upload-area"
                  ...
                  ${r.image?j`
                     ${r.image_crop_meta?j`<div style="width:100%; height:100%; border-radius:10px; ${is.getCropStyle(r.image,r.image_crop_meta)}; background-repeat: no-repeat;"></div>`:j`<img src="${r.image}" style="width:100%; height:100%; object-fit:cover; border-radius:10px;" />`}
            ...
            <div class="editor-col">
               <div class="sd-form-group">
                  ...
                  <div class="type-selector-grid">
                     ${["Indica","Sativa","Hybrid","Ruderalis"].map(e=>{let t=De;"Indica"===e&&(t=Oe),"Sativa"===e&&(t=Ie),"Hybrid"===e&&(t=Te);const i=(r.type||"").toLowerCase()===e.toLowerCase();return j`
    ...
    `}static renderMD3TextInput(e,t,r){return j`
    ...
    `}static renderMD3SelectInput(e,t,r,i){return j`
      <div class="md3-input-group">
        <label class="md3-label">${e}</label>
        <select
          class="md3-input"
        ...
        >
          ...
          ${r.map(e=>j`<option value="${e}" ?selected=${e===t}>${e}</option>`)}
        </select>
      </div>
    `}static renderMD3NumberInput(e,t,r){return j`
      <div class="md3-input-group">
        <label class="md3-label">${e}</label>
        <input
          type="number"
    ...
    `}static renderMD3DateInput(e,t,r){const i=Xa.toDateTimeLocal(t);return j`
      <div class="md3-input-group">
        <label class="md3-label">${e}</label>
        <input
          type="datetime-local"
    ...
    `}static renderTextInput(e,t,r){return j`
    ...
    `}static renderNumberInput(e,t,r){return j`
      <div class="form-group">
        <label>${e}</label>
        <input 
          type="number" 
    ...
    `}static renderDateTimeInput(e,t,r,i){return j`
      <div class="form-group">
        <label>
    ...
    `:j``}static renderPlantStats(e){return this.renderPlantStatsMD3(e)}static renderConfigDialog(e,t,r){if(!e?.open)return j``;const i=e.currentTab;return j`
      <ha-dialog
        open
        @closed=${r.onClose}
        hideActions
    ...
    `}static renderAddGrowspaceTab(e,t){const r=e.addGrowspaceData;return j`
    ...
    `}static renderEnvironmentTab(e,t,r){const i=e.environmentData,a=Object.entries(t).map(([e,t])=>({id:e,name:t}));return j`
       <div style="display:flex; flex-direction:column; gap:20px;">
          <div class="detail-card">
             <h3>Select Target</h3>
             <div class="md3-input-group">
    ...
    `}static renderGlobalTab(e,t){const r=e.globalData;return j`
       <div style="display:flex; flex-direction:column; gap:20px;">
          <div class="detail-card">
    ...
    `}static renderGrowMasterDialog(e,t,r,i){if(!e?.open)return j``;const a=t?"#FF9800":"#4CAF50",s=r?`Ask the ${r}`:"Ask the Grow Master";return j`
      <ha-dialog
        open
        @closed=${i.onClose}
        hideActions
    ...
    `:j``}static openOptionsFlow({hass:e,entityId:t,startStep:r}){return new Promise((e,i)=>{try{!function(e,t,r,i){i=i||{},r=null==r?{}:r;var a=new Event(t,{bubbles:void 0===i.bubbles||i.bubbles,cancelable:Boolean(i.cancelable),composed:void 0===i.composed||i.composed});a.detail=r,e.dispatchEvent(a)}(window,"show-dialog",{dialogTag:"ha-config-option-flow",dialogParams:{entity_id:t,startStep:r}}),e()}catch(e){i(e)}})}}let as=class extends oe{constructor(){super(...arguments),this._addPlantDialog=null,this._defaultApplied=!1,this._plantOverviewDialog=null,this._strainLibraryDialog=null,this._configDialog=null,this._growMasterDialog=null,this._strainRecommendationDialog=null,this.selectedDevice=null,this._draggedPlant=null,this._isCompactView=!1,this._historyData=null,this._activeEnvGraphs=new Set,this._tooltip=null,this._menuOpen=!1,this._handleDocumentClick=e=>{if(this._menuOpen){const t=e.composedPath(),r=this.shadowRoot?.querySelector(".menu-container");r&&!t.includes(r)&&(this._menuOpen=!1)}},this._handleTakeClone=e=>{const t=e.attributes?.plant_id||e.entity_id.replace("sensor.","");this.hass.callService("growspace_manager","take_clone",{mother_plant_id:t}).then(()=>{console.log(`Clone taken from ${e.attributes?.strain||"plant"}`)}).catch(e=>{console.error(`Failed to take clone: ${e.message}`)})},this.clonePlant=(e,t)=>{const r=e.attributes?.plant_id||e.entity_id.replace("sensor.",""),i=t;this.hass.callService("growspace_manager","take_clone",{mother_plant_id:r,num_clones:i}).then(()=>{console.log(`Clone taken from ${e.attributes?.strain||"plant"}`)}).catch(e=>{console.error(`Failed to take clone: ${e.message}`)})}}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._handleDocumentClick)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._handleDocumentClick)}firstUpdated(){this.dataService=new es(this.hass),this.initializeSelectedDevice(),this._fetchHistory()}updated(e){super.updated(e),e.has("selectedDevice")&&this._fetchHistory()}async _fetchHistory(){if(!this.hass||!this.selectedDevice)return;const e=this.dataService.getGrowspaceDevices().find(e=>e.device_id===this.selectedDevice);if(!e)return;let t=e.name.toLowerCase().replace(/\s+/g,"_");e.overview_entity_id&&(t=e.overview_entity_id.replace("sensor.",""));let r=`binary_sensor.${t}_optimal_conditions`;"cure"===t?r="binary_sensor.cure_optimal_curing":"dry"===t&&(r="binary_sensor.dry_optimal_drying");const i=new Date,a=new Date(i.getTime()-864e5);try{const e=await this.dataService.getHistory(r,a,i);this._historyData=e}catch(e){console.error("Failed to fetch history",e)}}initializeSelectedDevice(){const e=this.dataService.getGrowspaceDevices();if(e.length&&!this.selectedDevice){if(this._config?.default_growspace){const t=e.find(e=>e.device_id===this._config.default_growspace||e.name===this._config.default_growspace);if(t)return void(this.selectedDevice=t.device_id)}this.selectedDevice=e[0].device_id}}static async getConfigElement(){await Promise.resolve().then(function(){return ns});return document.createElement("growspace-manager-card-editor")}static getStubConfig(){return{default_growspace:"4x4",compact:!0}}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config=e,void 0!==this._config.compact&&(this._isCompactView=this._config.compact)}getCardSize(){return 4}_handleDeviceChange(e){const t=e.target;this.selectedDevice=t.value}_handlePlantClick(e){this._plantOverviewDialog={open:!0,plant:e,editedAttributes:{...e.attributes}}}getHaDateTimeString(){const e=this.hass.config.time_zone||Intl.DateTimeFormat().resolvedOptions().timeZone;return Ja.now().setZone(e).toFormat("yyyy-LL-dd'T'HH:mm")}_openAddPlantDialog(e,t){const r=this.getHaDateTimeString(),i=this.dataService.getStrainLibrary(),a=i.length>0?i[0].strain:"",s=i.length>0?i[0].phenotype:"";this._addPlantDialog={open:!0,row:e,col:t,strain:a,phenotype:s,veg_start:r,flower_start:r,seedling_start:r,mother_start:r,clone_start:r,dry_start:r,cure_start:r}}async _confirmAddPlant(){if(!this._addPlantDialog||!this.selectedDevice)return;if(!this._addPlantDialog.strain)return void alert("Please enter a strain!");const{row:e,col:t,strain:r,phenotype:i,veg_start:a,flower_start:s,seedling_start:n,mother_start:o,clone_start:l,dry_start:c,cure_start:d}=this._addPlantDialog;try{const a={growspace_id:this.selectedDevice,row:e+1,col:t+1,strain:r,phenotype:i};["veg_start","flower_start","seedling_start","mother_start","clone_start","dry_start","cure_start"].forEach(e=>{const t=this._addPlantDialog[e];t&&(a[e]=Xa.formatDateForBackend(t))}),console.log("Adding plant to growspace:",this.selectedDevice,a),console.log("Adding plant:",a),await this.dataService.addPlant(a),this._addPlantDialog=null}catch(e){console.error("Error adding plant:",e)}}async _updatePlant(){if(!this._plantOverviewDialog)return;const{plant:e,editedAttributes:t}=this._plantOverviewDialog,r={plant_id:e.attributes?.plant_id||e.entity_id.replace("sensor.","")},i=["seedling_start","mother_start","clone_start","veg_start","flower_start","dry_start","cure_start"];["strain","phenotype","row","col",...i].forEach(e=>{if(void 0!==t[e]&&null!==t[e])if(i.includes(e)){const i=Xa.formatDateForBackend(String(t[e]));i&&(r[e]=i)}else r[e]=t[e]});try{await this.dataService.updatePlant(r),this._plantOverviewDialog=null}catch(e){console.error("Error updating plant:",e)}}async _handleDeletePlant(e){if(confirm("Are you sure you want to delete this plant?"))try{await this.dataService.removePlant(e),this._plantOverviewDialog=null}catch(e){console.error("Error deleting plant:",e)}}async _movePlantToNextStage(e){if(!this._plantOverviewDialog?.plant)return void console.error("No plant found in overview dialog");const t=this._plantOverviewDialog.plant,r=t.attributes?.stage;let i="";const a=new Set(["mother","flower","dry","cure"]);if(r&&a.has(r)){"flower"===r?i="dry":"dry"===r?i="cure":"mother"===r?i="clone":(console.error("Unknown stage, cannot move plant",i),i="error");try{const e=t.attributes?.plant_id||t.entity_id.replace("sensor.","");await this.dataService.harvestPlant(e,i),this._plantOverviewDialog=null}catch(e){console.error("Error moving plant to next stage:",e)}}else alert("Plant must be in mother or flower or dry or cure stage to move. stage is "+r)}async _harvestPlant(e){await this._movePlantToNextStage(e)}async _finishDryingPlant(e){await this._movePlantToNextStage(e)}_openStrainLibraryDialog(){const e=this.dataService.getStrainLibrary();this._strainLibraryDialog={open:!0,view:"browse",strains:e,searchQuery:"",editorState:this._createEmptyEditorState()}}_createEmptyEditorState(){return{strain:"",phenotype:"",breeder:"",type:"",flowering_min:"",flowering_max:"",lineage:"",sex:"",description:"",image:"",image_crop_meta:void 0}}_switchStrainView(e,t){this._strainLibraryDialog&&(this._strainLibraryDialog.view=e,this._strainLibraryDialog.isCropping=!1,"editor"===e&&(this._strainLibraryDialog.editorState=t?{strain:t.strain,phenotype:t.phenotype||"",breeder:t.breeder||"",type:t.type||"",flowering_min:t.flowering_days_min?.toString()||"",flowering_max:t.flowering_days_max?.toString()||"",lineage:t.lineage||"",sex:t.sex||"",description:t.description||"",image:t.image||"",image_crop_meta:t.image_crop_meta,sativa_percentage:t.sativa_percentage,indica_percentage:t.indica_percentage}:this._createEmptyEditorState()),this.requestUpdate())}_openIrrigationDialog(){if(!this.hass||!this.selectedDevice)return;const e=this.dataService.getGrowspaceDevices().find(e=>e.device_id===this.selectedDevice);e&&e.overview_entity_id?is.openOptionsFlow({hass:this.hass,entityId:e.overview_entity_id,startStep:"select_growspace_for_irrigation"}).catch(e=>{console.error("Failed to open Irrigation Options Flow:",e)}):console.error("Cannot open irrigation dialog: No overview entity found for selected device.")}_handleStrainEditorChange(e,t){this._strainLibraryDialog&&this._strainLibraryDialog.editorState&&(this._strainLibraryDialog.editorState[e]=t,this.requestUpdate())}_toggleCropMode(e){this._strainLibraryDialog&&(this._strainLibraryDialog.isCropping=e,this.requestUpdate())}_toggleImageSelector(e){this._strainLibraryDialog&&(this._strainLibraryDialog.isImageSelectorOpen=e,this.requestUpdate())}_handleSelectLibraryImage(e){if(this._strainLibraryDialog&&this._strainLibraryDialog.editorState){this._strainLibraryDialog.editorState.image=e;const t=this._strainLibraryDialog.strains.find(t=>t.image===e&&!!t.image_crop_meta);t&&t.image_crop_meta?this._strainLibraryDialog.editorState.image_crop_meta={...t.image_crop_meta}:this._strainLibraryDialog.editorState.image_crop_meta=void 0,this._strainLibraryDialog.isImageSelectorOpen=!1,this.requestUpdate()}}_toggleEnvGraph(e){const t=new Set(this._activeEnvGraphs);t.has(e)?t.delete(e):t.add(e),this._activeEnvGraphs=t,this.requestUpdate()}_handleGraphHover(e,t,r,i,a){const s=e.clientX-i.left,n=i.width,o=new Date,l=new Date(o.getTime()-864e5).getTime(),c=l+s/n*(o.getTime()-l);let d=r[0],p=Math.abs(c-d.time);for(let e=1;e<r.length;e++){const t=Math.abs(c-r[e].time);t<p&&(p=t,d=r[e])}const u=new Date(c).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:!0}).toLowerCase();let h=`${d.value} ${a}`;"state"===a&&(h=1===d.value?"Optimal Conditions":d.meta||"Not Optimal"),this._tooltip={id:t,x:s,time:u,value:h}}renderEnvGraph(e,t,r,i,a="line"){if(!this._historyData||0===this._historyData.length)return j``;const s=[...this._historyData].sort((e,t)=>new Date(e.last_changed).getTime()-new Date(t.last_changed).getTime()),n=new Date,o=new Date(n.getTime()-864e5),l=[];if(s.forEach(t=>{const r=new Date(t.last_changed).getTime();if(r<o.getTime())return;const a=((e,t)=>{if(e&&e.attributes)return"state"===i&&"optimal"===t?"on"===e.state?1:0:"light"===t?!0===(e.attributes.is_lights_on??e.attributes.observations?.is_lights_on)?1:0:void 0!==e.attributes[t]?e.attributes[t]:e.attributes.observations&&"object"==typeof e.attributes.observations?e.attributes.observations[t]:void 0})(t,e),s=((e,t)=>{if("state"===i&&"optimal"===t)return e.attributes.reasons;if("light"===t)return{state:e.attributes.is_lights_on??e.attributes.observations?.is_lights_on?"ON":"OFF"}})(t,e);void 0===a||isNaN(parseFloat(a))||l.push({time:r,value:parseFloat(a),meta:s})}),l.length<2&&"step"!==a)return j``;const c=1e3,d="step"===a?100:180;let p=0,u=1;"state"!==i&&(p=Math.min(...l.map(e=>e.value)),u=Math.max(...l.map(e=>e.value)));const h=u-p||1,g=p-.1*h,m=u+.1*h,f=m-g,v=l.length>0?l.reduce((e,t)=>e+t.value,0)/l.length:(p+u)/2;let y="";if("step"===a){const e=[];let t=l.length>0?l[0].value:0;e.push([0,d-(t-g)/f*d]),l.forEach(r=>{const i=(r.time-o.getTime())/864e5*c,a=d-(r.value-g)/f*d;e.push([i,e[e.length-1][1]]),e.push([i,a]),t=r.value}),e.push([c,d-(t-g)/f*d]),y=`M ${e.map(e=>`${e[0]},${e[1]}`).join(" L ")}`}else{const e=l.map(e=>[(e.time-o.getTime())/864e5*c,d-(e.value-g)/f*d]);y=`M ${e.map(e=>`${e[0]},${e[1]}`).join(" L ")}`}if("step"===a)return j`
        <div class="gs-light-cycle-card" style="margin-top: 12px; border: 1px solid ${t}40;">
           <div class="gs-light-header-row" @click=${()=>this._toggleEnvGraph(e)}>
               <div class="gs-light-title" style="font-size: 1.2rem;">
                   ...
                   <div>
                      <div>${r}</div>
                      <div class="gs-light-subtitle">24H HISTORY • ${(()=>{if("light"===e){const e=this.dataService.getGrowspaceDevices().find(e=>e.device_id===this.selectedDevice);if(e){const t=`binary_sensor.${e.device_id}_light_schedule_correct`,r=this.hass.states[t];if(r?.attributes["Expected schedule"])return r.attributes["Expected schedule"]}return 1===l[l.length-1]?.value?"ON":"OFF"}return"state"===i?1===l[l.length-1]?.value?"OPTIMAL":"NOT OPTIMAL":`${p.toFixed(1)} - ${u.toFixed(1)} ${i}`})()}</div>
                   </div>
               </div>
           ...
           <div class="gs-chart-container" style="height: 100px;"
               ...
               <svg class="gs-chart-svg" viewBox="0 0 1000 100" preserveAspectRatio="none">
                   ...
                   <path class="chart-line" d="${y}" style="stroke: ${t};" />
                   <path class="chart-gradient-fill" d="${y} V 100 H 0 Z" style="fill: url(#grad-${e});" />
               </svg>
      ...
      `;const b=[m,m-.25*f,m-.5*f,m-.75*f,g];return j`
      <div class="gs-env-graph-card" style="margin-top: 12px; background: #1a1a1a; border-radius: 12px; padding: 16px;">
         <div class="gs-env-graph-header" style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px; cursor: pointer;" @click=${()=>this._toggleEnvGraph(e)}>
             <div style="display: flex; align-items: center; gap: 12px;">
                 <svg style="width:24px;height:24px;fill:${t};" viewBox="0 0 24 24"><path d="${ke}"></path></svg>
                 <div>
                    <div style="font-size: 0.9rem; font-weight: 600; color: #fff;">${r}</div>
                    <div style="font-size: 0.75rem; color: #999;">24H HISTORY</div>
                 </div>
             </div>
             <div style="text-align: right;">
                <div style="font-size: 0.85rem; color: #999;">${p.toFixed(1)} - ${u.toFixed(1)} ${i}</div>
             </div>
         </div>
         ...
         <div class="gs-env-chart-container" style="position: relative; height: 180px; background: #0d0d0d; border-radius: 8px; padding: 20px 40px 30px 50px;"
             ...
             <div style="position: absolute; left: 0; top: 20px; bottom: 30px; width: 45px; display: flex; flex-direction: column; justify-content: space-between; font-size: 0.65rem; color: #666; text-align: right; padding-right: 8px;">
                ${b.map(e=>j`<div>${e.toFixed(1)} ${i}</div>`)}
             </div>
             ...
             <svg style="position: absolute; left: 50px; top: 20px; right: 40px; bottom: 30px; width: calc(100% - 90px); height: calc(100% - 50px);" viewBox="0 0 1000 ${d}" preserveAspectRatio="none">
                 ...
                 <!-- Data line and fill -->
                 <path d="${y} V ${d} H 0 Z" fill="url(#grad-${e})" />
                 <path d="${y}" fill="none" stroke="${t}" stroke-width="2.5" />
             </svg>
    ...
    `}_setStrainSearchQuery(e){this._strainLibraryDialog&&(this._strainLibraryDialog.searchQuery=e,this.requestUpdate())}_toggleAddStrainForm(){}_promptClearAll(){}_cancelClearAll(){}async _addStrain(){if(!this._strainLibraryDialog?.editorState?.strain)return;const e=this._strainLibraryDialog.editorState,t={strain:e.strain,phenotype:e.phenotype,breeder:e.breeder,type:e.type,flowering_days_min:e.flowering_min?parseInt(e.flowering_min):void 0,flowering_days_max:e.flowering_max?parseInt(e.flowering_max):void 0,lineage:e.lineage,sex:e.sex,description:e.description,image:e.image,image_crop_meta:e.image_crop_meta,sativa_percentage:e.sativa_percentage,indica_percentage:e.indica_percentage};try{await this.dataService.addStrain(t);const r=`${e.strain}|${e.phenotype||"default"}`,i={key:r,strain:e.strain,phenotype:e.phenotype,breeder:e.breeder,type:e.type,flowering_days_min:t.flowering_days_min,flowering_days_max:t.flowering_days_max,lineage:e.lineage,sex:e.sex,description:e.description,image:e.image,image_crop_meta:e.image_crop_meta,sativa_percentage:e.sativa_percentage,indica_percentage:e.indica_percentage};this._strainLibraryDialog.strains=this._strainLibraryDialog.strains.filter(e=>e.key!==r),this._strainLibraryDialog.strains.push(i),this._switchStrainView("browse")}catch(e){console.error("Error adding strain:",e)}}async _removeStrain(e){if(this._strainLibraryDialog)try{const t=e.split("|"),r=t[0],i=t.length>1&&"default"!==t[1]?t[1]:void 0;await this.dataService.removeStrain(r,i),this._strainLibraryDialog.strains=this._strainLibraryDialog.strains.filter(t=>t.key!==e),this.requestUpdate()}catch(e){console.error("Error removing strain:",e)}}async _clearStrains(){await this.dataService.clearStrainLibrary(),this._strainLibraryDialog&&(this._strainLibraryDialog.strains=[],this._strainLibraryDialog.confirmClearAll=!1,this.requestUpdate())}async _handleExportLibrary(){const e=await this.hass.connection.subscribeEvents(t=>{t.data&&t.data.url&&(this._downloadFile(t.data.url),e())},"growspace_manager_strain_library_exported");try{await this.hass.callService("growspace_manager","export_strain_library")}catch(t){console.error("Failed to call export service",t),e()}}_downloadFile(e){const t=document.createElement("a");t.style.display="none",t.href=e,t.download=e.split("/").pop()||"export.zip",document.body.appendChild(t),t.click(),document.body.removeChild(t)}_openImportDialog(){this._strainLibraryDialog&&(this._strainLibraryDialog.importDialog={open:!0,replace:!1},this.requestUpdate())}_handleImportDialogChange(e){this._strainLibraryDialog&&this._strainLibraryDialog.importDialog&&(void 0!==e.open&&(this._strainLibraryDialog.importDialog.open=e.open),void 0!==e.replace&&(this._strainLibraryDialog.importDialog.replace=e.replace),this.requestUpdate())}async _performImport(){if(!this._strainLibraryDialog?.importDialog)return;const e=this._strainLibraryDialog.importDialog.replace,t=document.createElement("input");t.type="file",t.accept=".zip",t.onchange=async t=>{const r=t.target.files?.[0];if(r)try{const t=await this.dataService.importStrainLibrary(r,e);alert(`Import successful! ${t.imported_count||""} strains imported.`),this._strainLibraryDialog&&this._strainLibraryDialog.importDialog&&(this._strainLibraryDialog.importDialog.open=!1),this.requestUpdate()}catch(e){console.error("Import failed:",e),alert(`Import failed: ${e.message}`)}},t.click()}updateGrid(){this.dataService=new es(this.hass),this.requestUpdate()}_handleDragStart(e,t){this._draggedPlant=t,e.dataTransfer?.setData("text/plain",JSON.stringify({id:t.entity_id}));e.target.classList.add("dragging")}_handleDragEnd(e){e.target.classList.remove("dragging")}_handleDragOver(e){e.preventDefault()}async _handleDrop(e,t,r,i){if(e.preventDefault(),!this._draggedPlant||!this.selectedDevice)return;const a=this._draggedPlant;this._draggedPlant=null;try{if(i){const e=a.attributes.plant_id||a.entity_id.replace("sensor.",""),t=i.attributes.plant_id||i.entity_id.replace("sensor.","");await this.hass.callService("growspace_manager","switch_plants",{plant1_id:e,plant2_id:t}),this.updateGrid()}else await this._movePlant(a,t,r)}catch(e){console.error("Error during drag-and-drop:",e)}}async _movePlant(e,t,r){try{const i=e.attributes?.plant_id||e.entity_id.replace("sensor.","");await this.dataService.updatePlant({plant_id:i,row:t,col:r})}catch(e){console.error("Error moving plant:",e)}}_moveClonePlant(e,t){this.hass.callService("growspace_manager","move_clone",{plant_id:e.attributes.plant_id,target_growspace_id:t}).then(()=>{console.log(`Moved clone ${e.attributes.friendly_name} to ${t}`),this._plantOverviewDialog=null}).catch(e=>{console.error("Error moving clone:",e)})}_openConfigDialog(){this._configDialog={open:!0,currentTab:"add_growspace",addGrowspaceData:{name:"",rows:3,plants_per_row:3,notification_service:""},environmentData:{selectedGrowspaceId:"",temp_sensor:"",humidity_sensor:"",vpd_sensor:"",co2_sensor:"",light_sensor:"",fan_switch:""},globalData:{weather_entity:"",lung_room_temp:"",lung_room_humidity:""}}}_handleAddGrowspaceSubmit(){if(!this._configDialog)return;const e=this._configDialog.addGrowspaceData;e.name?this.dataService.addGrowspace(e).then(()=>{this._configDialog=null,this.requestUpdate()}).catch(e=>alert(`Error: ${e.message}`)):alert("Name is required")}_handleEnvSubmit(){if(!this._configDialog)return;const e=this._configDialog.environmentData;e.selectedGrowspaceId&&e.temp_sensor&&e.humidity_sensor&&e.vpd_sensor?this.dataService.configureGrowspaceSensors({growspace_id:e.selectedGrowspaceId,temperature_sensor:e.temp_sensor,humidity_sensor:e.humidity_sensor,vpd_sensor:e.vpd_sensor,co2_sensor:e.co2_sensor||void 0,light_sensor:e.light_sensor||void 0,fan_switch:e.fan_switch||void 0}).then(()=>{this._configDialog=null,this.requestUpdate()}).catch(e=>alert(`Error: ${e.message}`)):alert("Growspace and required sensors (Temp, Hum, VPD) are mandatory")}_handleGlobalSubmit(){if(!this._configDialog)return;const e=this._configDialog.globalData;this.dataService.configureGlobalSettings(e).then(()=>{this._configDialog=null,this.requestUpdate()}).catch(e=>alert(`Error: ${e.message}`))}_openGrowMasterDialog(){this.selectedDevice&&(this._growMasterDialog={open:!0,growspaceId:this.selectedDevice,userQuery:"",isLoading:!1,response:null,mode:"single"})}async _handleAskAdvice(){if(this._growMasterDialog&&this._growMasterDialog.userQuery){this._growMasterDialog.isLoading=!0,this._growMasterDialog.response=null,this.requestUpdate();try{const e=await this.dataService.askGrowAdvice(this._growMasterDialog.growspaceId,this._growMasterDialog.userQuery);this._growMasterDialog&&(e&&e.response?"string"==typeof e.response?this._growMasterDialog.response=e.response:"object"==typeof e.response&&"response"in e.response&&"string"==typeof e.response.response?this._growMasterDialog.response=e.response.response:this._growMasterDialog.response=JSON.stringify(e,null,2):this._growMasterDialog.response=JSON.stringify(e,null,2))}catch(e){this._growMasterDialog&&(this._growMasterDialog.response=`Error: ${e.message||"Failed to get advice."}`)}finally{this._growMasterDialog&&(this._growMasterDialog.isLoading=!1,this.requestUpdate())}}}async _handleAnalyzeAll(){if(this._growMasterDialog){this._growMasterDialog.isLoading=!0,this._growMasterDialog.response=null,this._growMasterDialog.mode="all",this.requestUpdate();try{const e=await this.dataService.analyzeAllGrowspaces();this._growMasterDialog&&(e&&e.response?"string"==typeof e.response?this._growMasterDialog.response=e.response:"object"==typeof e.response&&"response"in e.response&&"string"==typeof e.response.response?this._growMasterDialog.response=e.response.response:this._growMasterDialog.response=JSON.stringify(e,null,2):this._growMasterDialog.response=JSON.stringify(e,null,2))}catch(e){this._growMasterDialog&&(this._growMasterDialog.response=`Error: ${e.message||"Failed to get advice."}`)}finally{this._growMasterDialog&&(this._growMasterDialog.isLoading=!1,this.requestUpdate())}}}async _handleGetStrainRecommendation(){if(this._strainRecommendationDialog&&this._strainRecommendationDialog.userQuery){this._strainRecommendationDialog.isLoading=!0,this._strainRecommendationDialog.response=null,this.requestUpdate();try{const e=await this.dataService.getStrainRecommendation(this._strainRecommendationDialog.userQuery);this._strainRecommendationDialog&&(e&&"string"==typeof e.response?this._strainRecommendationDialog.response=e.response:this._strainRecommendationDialog.response=JSON.stringify(e,null,2))}catch(e){this._strainRecommendationDialog&&(this._strainRecommendationDialog.response=`Error: ${e.message||"Failed to get recommendation."}`)}finally{this._strainRecommendationDialog&&(this._strainRecommendationDialog.isLoading=!1,this.requestUpdate())}}}_openStrainRecommendationDialog(){this._strainRecommendationDialog={open:!0,userQuery:"",isLoading:!1,response:null}}render(){if(!this.hass)return j`<ha-card><div class="error">Home Assistant not available</div></ha-card>`;this.dataService=new es(this.hass);const e=this.dataService.getGrowspaceDevices();if(!e.length)return j`<ha-card><div class="no-data">No growspace devices found.</div></ha-card>`;if(!this._defaultApplied&&this._config?.default_growspace){const t=e.find(e=>e.device_id===this._config.default_growspace||e.name===this._config.default_growspace);t&&(this.selectedDevice=t.device_id),this._defaultApplied=!0}this.selectedDevice&&e.find(e=>e.device_id===this.selectedDevice)||(this.selectedDevice=e[0].device_id);const t=e.find(e=>e.device_id===this.selectedDevice);if(!t)return j`<ha-card><div class="error">No valid growspace selected.</div></ha-card>`;const r=this.hass.states["sensor.growspaces_list"]?.attributes?.growspaces;r&&Object.entries(r).forEach(([e,t])=>{});const i=Xa.calculateEffectiveRows(t),{grid:a}=Xa.createGridLayout(t.plants,i,t.plants_per_row),s=t.plants_per_row>6,n=this.dataService.getStrainLibrary();return j`
      ...
      ${this.renderDialogs()}
    `}renderGrowspaceHeader(e){const t=Xa.getDominantStage(e.plants),r=this.dataService.getGrowspaceDevices();let i=e.name.toLowerCase().replace(/\s+/g,"_");e.overview_entity_id&&(i=e.overview_entity_id.replace("sensor.",""));let a=`binary_sensor.${i}_optimal_conditions`;const s="cure"===i,n="dry"===i;s?a="binary_sensor.cure_optimal_curing":n&&(a="binary_sensor.dry_optimal_drying");const o=this.hass.states[a],l=(e,t)=>{if(e&&e.attributes)return void 0!==e.attributes[t]?e.attributes[t]:e.attributes.observations&&"object"==typeof e.attributes.observations?e.attributes.observations[t]:void 0},c=l(o,"temperature"),d=l(o,"humidity"),p=l(o,"vpd"),u=s||n,h=u?void 0:l(o,"co2"),g=l(o,"is_lights_on"),m=!u&&null!=g,f=!0===g;e.plants.some(e=>"flower"===e.attributes.stage);let v=[];if(this._historyData&&this._historyData.length>0){const e=[...this._historyData].sort((e,t)=>new Date(e.last_changed).getTime()-new Date(t.last_changed).getTime()),t=new Date,r=new Date(t.getTime()-864e5),i=1e3,a=100,s=[];let n=e.length>0?!0!==l(e[0],"is_lights_on"):f;e.forEach(e=>{const t=new Date(e.last_changed).getTime(),i=!0===l(e,"is_lights_on");t>=r.getTime()&&v.push({time:t,state:i})}),n=v.length>0?!v[0].state:f,s.push([0,n?0:a]),v.forEach(e=>{const t=(e.time-r.getTime())/864e5*i;s.push([t,n?0:a]),n=e.state,s.push([t,n?0:a])}),s.push([i,n?0:a]),s.map(e=>`${e[0]},${e[1]}`).join(" L ");const o=[...e].reverse(),c=o.find(e=>!0===l(e,"is_lights_on"));if(c){const e=new Date(c.last_changed);e.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:!0}).replace(/ [AP]M/,""),e.toLocaleTimeString([],{hour12:!0}).slice(-2)}const d=o.find(e=>!1===l(e,"is_lights_on"));if(d){const e=new Date(d.last_changed);e.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:!0}).replace(/ [AP]M/,""),e.toLocaleTimeString([],{hour12:!0}).slice(-2)}}return j`
            ...
            <div class="gs-title-group">
               ...
               `:j`
                 <select class="growspace-select-header" .value=${this.selectedDevice||""} @change=${this._handleDeviceChange}>
                    ${r.map(e=>j`<option value="${e.device_id}">${e.name}</option>`)}
                 </select>
               `}
...
<!-- Active Environmental Graphs -->
  ...
  `}renderHeader(e){return this._isCompactView||this._config?.title?(e.find(e=>e.device_id===this.selectedDevice),j`
    ...
    `):j``}renderGrid(e,t,r,i){const a=r>5,s=a?"":`grid-template-columns: repeat(${r}, minmax(0, 1fr)); grid-template-rows: repeat(${t}, 1fr);`;return j`
    ...
    `}renderPlantSlot(e,t,r,i){const a=Xa.getPlantStageColor(e.state),s=e.attributes?.strain,n=e.attributes?.phenotype;let o;if(s){const e=i.find(e=>e.strain===s&&e.phenotype===n);if(e&&e.image)o=e.image;else{const e=i.find(e=>e.strain===s&&(!e.phenotype||"default"===e.phenotype));if(e&&e.image)o=e.image;else if(!o){const e=i.find(e=>e.strain===s&&e.image);e&&(o=e.image)}}}const l=o?`background-image: url('${o}');`:"";return j`
      ...
      >
        ${o?j`<div class="plant-card-bg" style="${l}"></div>
    ...
    `}renderPlantDaysRich(e){const t=[{days:e.attributes?.seedling_days,icon:Me,title:"Seedling",stage:"seedling"},{days:e.attributes?.mother_days,icon:Me,title:"Mother",stage:"mother"},{days:e.attributes?.clone_days,icon:Me,title:"Clone",stage:"clone"},{days:e.attributes?.veg_days,icon:Me,title:"Veg",stage:"vegetative"},{days:e.attributes?.flower_days,icon:$e,title:"Flower",stage:"flower"},{days:e.attributes?.dry_days,icon:Se,title:"Dry",stage:"dry"},{days:e.attributes?.cure_days,icon:me,title:"Cure",stage:"cure"}].filter(e=>void 0!==e.days&&null!==e.days),r=t.filter(e=>e.days),i=(e.state||"").toLowerCase(),a="veg"===i?"vegetative":i;return j`
        ${r.map(e=>{const t=Xa.getPlantStageColor(e.stage),r=e.stage===a;return j`
            ...
            `})}
    `}renderDialogs(){const e=this.dataService?.getStrainLibrary()||[],t={},r=this.hass.states["sensor.growspaces_list"]?.attributes?.growspaces;r&&Object.entries(r).forEach(([e,r])=>{t[e]=r});const i=this.dataService.getGrowspaceDevices().find(e=>e.device_id===this.selectedDevice);return j`
    ...
    `],e([he(),t("design:type",Object)],as.prototype,"_addPlantDialog",void 0),e([he(),t("design:type",Object)],as.prototype,"_defaultApplied",void 0),e([he(),t("design:type",Object)],as.prototype,"_plantOverviewDialog",void 0),e([he(),t("design:type",Object)],as.prototype,"_strainLibraryDialog",void 0),e([he(),t("design:type",Object)],as.prototype,"_configDialog",void 0),e([he(),t("design:type",Object)],as.prototype,"_growMasterDialog",void 0),e([he(),t("design:type",Object)],as.prototype,"_strainRecommendationDialog",void 0),e([he(),t("design:type",Object)],as.prototype,"selectedDevice",void 0),e([he(),t("design:type",Object)],as.prototype,"_draggedPlant",void 0),e([he(),t("design:type",Boolean)],as.prototype,"_isCompactView",void 0),e([he(),t("design:type",Object)],as.prototype,"_historyData",void 0),e([he(),t("design:type",Set)],as.prototype,"_activeEnvGraphs",void 0),e([he(),t("design:type",Object)],as.prototype,"_tooltip",void 0),e([he(),t("design:type",Boolean)],as.prototype,"_menuOpen",void 0),e([ue({attribute:!1}),t("design:type",Object)],as.prototype,"hass",void 0),e([ue({attribute:!1}),t("design:type",Object)],as.prototype,"_config",void 0),as=e([ce("growspace-manager-card")],as);let ss=class extends oe{constructor(){super(...arguments),this._growspaceOptions=[]}setConfig(e){this._config=e,this._loadGrowspaces()}updated(e){e.has("hass")&&this.hass&&(this._loadGrowspaces(),this._subscribeToSensorUpdates())}disconnectedCallback(){super.disconnectedCallback(),this._unsubStateChanged&&(this._unsubStateChanged(),this._unsubStateChanged=void 0)}_subscribeToSensorUpdates(){this.hass&&!this._unsubStateChanged&&(this._unsubStateChanged=this.hass.connection.subscribeEvents(e=>{const t=e.data.new_state;"sensor.growspaces_list"===t?.entity_id&&(Array.isArray(t.attributes?.growspaces)?this._growspaceOptions=t.attributes.growspaces:this._growspaceOptions=[])},"state_changed"))}_loadGrowspaces(){if(!this.hass)return;const e=this.hass.states["sensor.growspaces_list"];if(e&&e.attributes?.growspaces){const t=e.attributes.growspaces;this._growspaceOptions=Object.values(t)}else this._growspaceOptions=[]}render(){return this._config?j`
      <div class="form-group">
    ...
    `:j``}_valueChanged(e,t){if(!this._config)return;const r={...this._config,[e]:t};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:r},bubbles:!0,composed:!0}))}};ss.styles=o`
    .form-group {
      margin-bottom: 12px;
    }
    label {
  ...
  `,e([ue({attribute:!1}),t("design:type",Object)],ss.prototype,"hass",void 0),e([ue({attribute:!1}),t("design:type",Object)],ss.prototype,"_config",void 0),e([he(),t("design:type",Array)],ss.prototype,"_growspaceOptions",void 0),ss=e([ce("growspace-manager-card-editor")],ss);var ns=Object.freeze({__proto__:null,get GrowspaceManagerCardEditor(){return ss}});export{as as GrowspaceManagerCard};
