/*! growspace-e2e-build source=acbbe4d05b5c9fff436e0c7fa170b77e026e06568556f73cea85c5c0b19476dd id=c07c513e5239911ab7231c5c2852845f */
...
import { g as getPrinters } from './growspace-growspace-dialog-host.container-DGAiay7Z.js';
import './growspace-config-dialog-B5sCN18e.js';
import './growspace-environment-ramp-CKU1qKTK.js';
...
_GrowspaceLabelRecordPrint_print = async function _GrowspaceLabelRecordPrint_print() {
    const record = this._record;
    if (!record || !record.decision.allowed)
        return;
      ...
      <section data-section="preview" aria-labelledby="record-preview">
        ...
        <div class="row">
          <button
            ...
            aria-describedby=${decision.allowed ? E : 'record-blocked'}
        ...
        ${decision.allowed
        ? E
        : x `<p class="supporting" id="record-blocked">
              ${this._t('print_record_blocked_hint')}
            </p>`}
      </section>
    `;
...
//# sourceMappingURL=growspace-label-templates-Y5XtvUS9.js.map
