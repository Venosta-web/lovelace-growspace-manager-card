...
const { eT: negotiatedContract, h: hassCall, eU: CONTRACT_INCOMPATIBLE, eV: recoverFromContractRefusal, eW: DraftOpenedSchema, eX: DraftSavedSchema, eY: DraftPreviewSchema, eZ: DraftPublishedSchema, e_: DraftDiscardedSchema, e$: LibraryAnswerSchema, f0: __classPrivateFieldSet, f1: __classPrivateFieldGet, f2: DRAFT_VERSION_CONFLICT, f3: DRAFT_VERSION_MISMATCH, f4: TextStyleSchema, cK: variables, i, _: __decorate, n, t, g: i$1, A: localize, x, bX: localizeWithParams, E, f5: object, f6: boolean, f7: string, f8: RenderResultSchema, f9: OperationEligibilitySchema, fa: number, fb: record, fc: array, fd: answer, fe: CapabilityProfileSchema, ff: LabelDocumentSchema, w: r, bp: e, fg: getHass, fh: profilesForSize, a0: fetchStrainLibrary, c7: o, j: mdiArrowLeft, fi: mdiUndo, fj: mdiRedo, a2: mdiContentCopy, l: mdiDelete, fk: mdiRestore, fl: mdiContentSaveOutline, ar: mdiRefresh, fm: mdiMagnifyMinusOutline, fn: mdiMagnifyPlusOutline, fo: mdiMagnifyScan, fp: ProvenanceSchema, fq: TemplateDraftSchema, fr: unknown, fs: PublicationCheckSchema, ft: discriminatedUnion, fu: LabelContractIdentitySchema, fv: literal, fw: LabelRefusalSchema, fx: DiagnosticSchema, fy: reconcileChoice, fz: labelSizeState, fA: previewFactoryTemplate, fB: labelSizes } = await import(window.__growspaceEntryUrl ?? './growspace-manager-card.js');
import { g as getPrinters } from './growspace-growspace-dialog-host.container-CBMshbEW.js';
import './growspace-config-dialog-CDepMvQT.js';
import './growspace-environment-ramp-BYFe6eVW.js';
...
function printLabelRecord(approvalId, rasterIdentity) {
    return gated(WS_PRINT_LABEL_RECORD, { approval_id: approvalId, expected_raster_identity: rasterIdentity }, PrintedAnswerSchema);
}
...
_GrowspaceLabelPrintPanel_printRecord = async function _GrowspaceLabelPrintPanel_printRecord() {
    const record = this._record;
    if (!record || !record.decision.allowed)
        return;
      ...
      <section data-section="record" aria-labelledby="print-record">
        ...
        ? x `
            ...
            : __classPrivateFieldGet(this, _GrowspaceLabelPrintPanel_instances, "m", _GrowspaceLabelPrintPanel_renderBlockers).call(this, record.decision.blocked_by)}
              ...
              <div class="row">
                <button
                  ...
                  aria-describedby=${record.decision.allowed ? E : 'record-blocked'}
            ...
            : E}
              ...
              ${record.decision.allowed
            ? E
            : x `<p class="reason" id="record-blocked">
 ...
 * review.
 */
function printLabelBatch(preflightId, acknowledgement) {
    return gated(WS_PRINT_LABEL_BATCH, { preflight_id: preflightId, ...(acknowledgement ? { acknowledgement } : {}) }, BatchJobAnswerSchema);
}
...
function retryLabelBatch(jobId, acknowledgement) {
    return gated(WS_RETRY_LABEL_BATCH, { job_id: jobId, ...(acknowledgement ? { acknowledgement } : {}) }, BatchJobAnswerSchema);
}
...
function mayPrint(preflight, acknowledged, changedSinceReview) {
    if (changedSinceReview || !preflight.allowed)
        return false;
 ...
 */
var _GrowspaceLabelBatch_instances, _GrowspaceLabelBatch_poll, _GrowspaceLabelBatch_first, _GrowspaceLabelBatch_plant, _GrowspaceLabelBatch_refusalCopy, _GrowspaceLabelBatch_blockerCopy, _GrowspaceLabelBatch_factoryOptions, _GrowspaceLabelBatch_loadTemplates, _GrowspaceLabelBatch_edit, _GrowspaceLabelBatch_preflight, _GrowspaceLabelBatch_goTo, _GrowspaceLabelBatch_acknowledge, _GrowspaceLabelBatch_print, _GrowspaceLabelBatch_retry, _GrowspaceLabelBatch_consent, _GrowspaceLabelBatch_start, _GrowspaceLabelBatch_take, _GrowspaceLabelBatch_schedulePoll, _GrowspaceLabelBatch_stopPolling, _GrowspaceLabelBatch_readJob, _GrowspaceLabelBatch_recover, _GrowspaceLabelBatch_transportRefusal, _GrowspaceLabelBatch_announce, _GrowspaceLabelBatch_renderSetup, _GrowspaceLabelBatch_renderRefusal, _GrowspaceLabelBatch_renderReview, _GrowspaceLabelBatch_renderNavigation, _GrowspaceLabelBatch_renderRecord, _GrowspaceLabelBatch_renderPlan, _GrowspaceLabelBatch_renderConsent, _GrowspaceLabelBatch_renderJob;
...
_GrowspaceLabelBatch_refusalCopy = function _GrowspaceLabelBatch_refusalCopy(refusal) {
    ...
    return __classPrivateFieldGet(this, _GrowspaceLabelBatch_instances, "m", _GrowspaceLabelBatch_first).call(this, [`batch_refusal_${code}`, `refusal_${code}`], 'refusal_generic');
};
...
async function _GrowspaceLabelBatch_preflight() {
    ...
    try {
        ...
        __classPrivateFieldGet(this, _GrowspaceLabelBatch_instances, "m", _GrowspaceLabelBatch_announce).call(this, this._t('batch_reviewed', {
...
_GrowspaceLabelBatch_retry = async function _GrowspaceLabelBatch_retry() {
    ...
    if (!job || !mayRetry(job))
        return;
    await __classPrivateFieldGet(this, _GrowspaceLabelBatch_instances, "m", _GrowspaceLabelBatch_start).call(this, () => retryLabelBatch(job.id, __classPrivateFieldGet(this, _GrowspaceLabelBatch_instances, "m", _GrowspaceLabelBatch_consent).call(this)));
};
...
_GrowspaceLabelBatch_renderReview = function _GrowspaceLabelBatch_renderReview(review, printing) {
    ...
    return x `
      <section data-section="review" aria-labelledby="batch-review">
        ...
        : E}
        ${__classPrivateFieldGet(this, _GrowspaceLabelBatch_instances, "m", _GrowspaceLabelBatch_renderNavigation).call(this, review)} ${__classPrivateFieldGet(this, _GrowspaceLabelBatch_instances, "m", _GrowspaceLabelBatch_renderRecord).call(this, review)}
...
//# sourceMappingURL=growspace-label-templates-Dk2RFXwi.js.map
