...
const defaultEnvSnapshot: EnvSnapshot = {
  ...
  drainVolume: {
    ...
    sum: 0.5,
    perSensor: [0.5],
    entityIds: ['sensor.test_tent_drain_volume'],
  },
  irrigationFlow: {
    avg: 2.3,
    sum: 2.3,
    perSensor: [2.3],
    entityIds: ['sensor.test_tent_irrigation_flow'],
  },
  ...
  return {
    ...
    recommendations: [
      aRecommendation({
        impact: 'high',
        title: 'Adjust pH',
        description: 'pH is outside target range.',
      }),
      aRecommendation({
        impact: 'low',
        title: 'Good airflow',
        description: 'Air circulation is excellent.',
      }),
    ],
    ai_available: true,
    ...overrides,
