...
const defaultEnvSnapshot: EnvSnapshot = {
  ...
  soilMoisture: { avg: 65, sum: 65, perSensor: [65], entityIds: ['sensor.test_tent_soil_moisture'] },
  substrateTemperature: { avg: 22.0, sum: 22.0, perSensor: [22.0], entityIds: ['sensor.test_tent_substrate_temp'] },
  ph: { avg: 6.2, sum: 6.2, perSensor: [6.2], entityIds: ['sensor.test_tent_ph'] },
  feedEc: { avg: 1.8, sum: 1.8, perSensor: [1.8], entityIds: ['sensor.test_tent_feed_ec'] },
  bulkEc: { avg: 2.1, sum: 2.1, perSensor: [2.1], entityIds: ['sensor.test_tent_bulk_ec'] },
  poreEc: { avg: 2.3, sum: 2.3, perSensor: [2.3], entityIds: ['sensor.test_tent_pore_ec'] },
  runoffEc: { avg: 1.9, sum: 1.9, perSensor: [1.9], entityIds: ['sensor.test_tent_runoff_ec'] },
  drainVolume: { avg: 0.5, sum: 0.5, perSensor: [0.5], entityIds: ['sensor.test_tent_drain_volume'] },
  irrigationFlow: { avg: 2.3, sum: 2.3, perSensor: [2.3], entityIds: ['sensor.test_tent_irrigation_flow'] },
  power: { avg: 420, sum: 420, perSensor: [420], entityIds: ['sensor.test_tent_power'] },
  energy: { avg: 5.6, sum: 5.6, perSensor: [5.6], entityIds: ['sensor.test_tent_energy'] },
};
