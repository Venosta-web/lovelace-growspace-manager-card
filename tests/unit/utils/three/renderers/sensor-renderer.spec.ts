...
vi.mock('three', async () => ({
  ...
  Vector3: vi.fn().mockImplementation(function (this: any, x, y, z) {
    mockVector3.call(this, x, y, z);
  }),
  ...
  CubicBezierCurve3: vi.fn().mockImplementation(function (this: any) {
    this.getPoints = vi.fn(() => []);
  }),
  CylinderGeometry: vi.fn().mockImplementation(function (this: any) {
    this.rotateX = vi.fn();
  }),
  TorusGeometry: vi.fn().mockImplementation(function (this: any) {
    this.rotateX = vi.fn();
  }),
