...
vi.mock('three', async () => {
  ...
  const BufferAttribute = vi.fn().mockImplementation(function (array, itemSize) {
    return {
      ...
      setY: vi.fn((i, v) => {
        array[i * itemSize + 1] = v;
      }),
      setZ: vi.fn((i, v) => {
        array[i * itemSize + 2] = v;
      }),
    };
  });
  ...
  return {
    ...
    Group: vi.fn().mockImplementation(function () {
      return {
        ...
        addMockChild: function (name: string, obj: any) {
          this._childrenMap[name] = obj;
        },
    ...
    BoxGeometry: vi.fn().mockImplementation(function () {
      return { attributes: { position: {} }, getIndex: vi.fn() };
    }),
    EdgesGeometry: vi.fn().mockImplementation(function () {
      return {};
    }),
