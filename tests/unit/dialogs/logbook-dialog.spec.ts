...
describe('LogbookDialog', () => {
  ...
  it('should dispatch close event when close button is clicked', async () => {
    ...
    const closeBtn = (gsDialog as any)?.shadowRoot?.querySelector(
  ...
  describe('Report Tab', () => {
    ...
    it('should fetch report data when report tab is selected', async () => {
      ...
      const envValue = element.shadowRoot
        ? Array.from(element.shadowRoot.querySelectorAll('.stat-value'))
        : [];
    ...
    it('should handle export actions', async () => {
      ...
      const buttons = element.shadowRoot
        ? Array.from(element.shadowRoot.querySelectorAll('.md3-button'))
        : [];
      const exportPdfBtn = buttons.find((b) =>
      ...
      const exportJsonBtn = buttons.find((b) =>
