...
describe('ConfigDialog - Complete Form Fill Tests', () => {
  ...
  beforeEach(async () => {
    ...
    mockHass = {
      states: {
        // Temperature sensors
        'sensor.temp_main': {
          entity_id: 'sensor.temp_main',
          attributes: { friendly_name: 'Main Temp', device_class: 'temperature' },
        },
        'sensor.temp_backup': {
          entity_id: 'sensor.temp_backup',
          attributes: { friendly_name: 'Backup Temp', device_class: 'temperature' },
        },
        // Humidity sensors
        'sensor.humidity_main': {
          entity_id: 'sensor.humidity_main',
          attributes: { friendly_name: 'Main Humidity', device_class: 'humidity' },
        },
        'sensor.humidity_backup': {
          entity_id: 'sensor.humidity_backup',
          attributes: { friendly_name: 'Backup Humidity', device_class: 'humidity' },
        },
        // VPD sensors
        'sensor.vpd_main': {
          entity_id: 'sensor.vpd_main',
          attributes: { friendly_name: 'Main VPD', device_class: 'pressure' },
        },
        // CO2 sensors
        'sensor.co2_main': {
          entity_id: 'sensor.co2_main',
          attributes: { friendly_name: 'Main CO2', device_class: 'carbon_dioxide' },
        },
        // Soil moisture sensors
        'sensor.soil_moisture_1': {
          entity_id: 'sensor.soil_moisture_1',
          attributes: { friendly_name: 'Soil 1', device_class: 'moisture' },
        },
        'sensor.soil_moisture_2': {
          entity_id: 'sensor.soil_moisture_2',
          attributes: { friendly_name: 'Soil 2', device_class: 'moisture' },
        },
        // Light sensors/switches
        'switch.light_main': {
          entity_id: 'switch.light_main',
          attributes: { friendly_name: 'Main Light' },
        },
        'switch.light_side': {
          entity_id: 'switch.light_side',
          attributes: { friendly_name: 'Side Light' },
        },
        'sensor.light_intensity': {
          entity_id: 'sensor.light_intensity',
          attributes: { friendly_name: 'Light Intensity' },
        },
        // Exhaust fans
        'fan.exhaust_main': {
          entity_id: 'fan.exhaust_main',
          attributes: { friendly_name: 'Main Exhaust' },
        },
        'switch.exhaust_backup': {
          entity_id: 'switch.exhaust_backup',
          attributes: { friendly_name: 'Backup Exhaust' },
        },
        // Circulation fans
        'fan.circulation_top': {
          entity_id: 'fan.circulation_top',
          attributes: { friendly_name: 'Top Circulation' },
        },
        'fan.circulation_bottom': {
          entity_id: 'fan.circulation_bottom',
          attributes: { friendly_name: 'Bottom Circulation' },
        },
        'switch.circulation_wall': {
          entity_id: 'switch.circulation_wall',
          attributes: { friendly_name: 'Wall Circulation' },
        },
        // Humidifiers
        'humidifier.main': {
          entity_id: 'humidifier.main',
          attributes: { friendly_name: 'Main Humidifier' },
        },
        'switch.humidifier_backup': {
          entity_id: 'switch.humidifier_backup',
          attributes: { friendly_name: 'Backup Humidifier' },
        },
        // Dehumidifiers
        'humidifier.dehumidifier_main': {
          entity_id: 'humidifier.dehumidifier_main',
          attributes: { friendly_name: 'Main Dehumidifier' },
        },
        'switch.dehumidifier_backup': {
          entity_id: 'switch.dehumidifier_backup',
          attributes: { friendly_name: 'Backup Dehumidifier' },
        },
      },
      services: {
        notify: {
  ...
  describe('DEHUMIDIFIER Tab - Complete Form Fill', () => {
    ...
    it('should update individual threshold points across all stages', async () => {
      ...
      const testUpdates = [
        ...
        { stage: DehumidifierStage.SEEDLING, cycle: 'night', point: 'on', value: 0.6 },
        { stage: DehumidifierStage.SEEDLING, cycle: 'night', point: 'off', value: 0.7 },

        { stage: DehumidifierStage.VEG, cycle: 'day', point: 'on', value: 0.65 },
        { stage: DehumidifierStage.VEG, cycle: 'day', point: 'off', value: 0.75 },
        { stage: DehumidifierStage.VEG, cycle: 'night', point: 'on', value: 0.7 },
        { stage: DehumidifierStage.VEG, cycle: 'night', point: 'off', value: 0.8 },
        ...
        { stage: DehumidifierStage.MID_FLOWER, cycle: 'day', point: 'on', value: 1.3 },
        { stage: DehumidifierStage.MID_FLOWER, cycle: 'day', point: 'off', value: 1.4 },
        ...
        { stage: DehumidifierStage.LATE_FLOWER, cycle: 'day', point: 'on', value: 1.4 },
        { stage: DehumidifierStage.LATE_FLOWER, cycle: 'day', point: 'off', value: 1.5 },
        { stage: DehumidifierStage.LATE_FLOWER, cycle: 'night', point: 'on', value: 1.0 },
        { stage: DehumidifierStage.LATE_FLOWER, cycle: 'night', point: 'off', value: 1.1 },

        { stage: DehumidifierStage.DRY, cycle: 'day', point: 'on', value: 0.85 },
        { stage: DehumidifierStage.DRY, cycle: 'day', point: 'off', value: 1.05 },
        { stage: DehumidifierStage.DRY, cycle: 'night', point: 'on', value: 0.9 },
        { stage: DehumidifierStage.DRY, cycle: 'night', point: 'off', value: 1.1 },

        { stage: DehumidifierStage.CURE, cycle: 'day', point: 'on', value: 0.95 },
        { stage: DehumidifierStage.CURE, cycle: 'day', point: 'off', value: 1.15 },
        { stage: DehumidifierStage.CURE, cycle: 'night', point: 'on', value: 1.0 },
        { stage: DehumidifierStage.CURE, cycle: 'night', point: 'off', value: 1.2 },
      ];
    ...
    it('should switch between all dehumidifier stages and verify threshold persistence', async () => {
      ...
      for (let i = 0; i < stages.length; i++) {
        ...
        expect((element as any).envDehumidifierThresholds[stage].day.off).toBeCloseTo(
          baseValue + 0.1,
          5
        );
        expect((element as any).envDehumidifierThresholds[stage].night.on).toBeCloseTo(
          baseValue + 0.05,
          5
        );
        expect((element as any).envDehumidifierThresholds[stage].night.off).toBeCloseTo(
          baseValue + 0.15,
          5
        );
      }
  ...
  describe('Complete Multi-Tab Workflow', () => {
    it('should successfully navigate and fill all tabs in sequence', async () => {
      ...
      expect((element as any).envDehumidifierThresholds[DehumidifierStage.SEEDLING].day.on).toBe(
        70
      );
      expect(
        (element as any).envDehumidifierThresholds[DehumidifierStage.VEGETATIVE].night.off
      ).toBe(65);
  ...
  describe('Edge Cases - Maximum Data Configuration', () => {
    ...
    it('should handle extreme threshold values', async () => {
      ...
      expect(
        (element as any).envDehumidifierThresholds[DehumidifierStage.VEGETATIVE].night.on
      ).toBe(99.99);
    });
  });
});
